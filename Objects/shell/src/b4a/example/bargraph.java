...
public static RemoteObject _shownmainpanel = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static RemoteObject _hideshowpanel = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Active1",_ref.getField(false, "_active1"),"btnBack",_ref.getField(false, "_btnback"),"btnNext",_ref.getField(false, "_btnnext"),"checkBoxes",_ref.getField(false, "_checkboxes"),"checkedSales",_ref.getField(false, "_checkedsales"),"color",_ref.getField(false, "_color"),"comId1",_ref.getField(false, "_comid1"),"currentPage",_ref.getField(false, "_currentpage"),"defBtn",_ref.getField(false, "_defbtn"),"hideShowPanel",_ref.getField(false, "_hideshowpanel"),"isFirstInit",_ref.getField(false, "_isfirstinit"),"itemsPerPage",_ref.getField(false, "_itemsperpage"),"layout",_ref.getField(false, "_layout"),"legend1",_ref.getField(false, "_legend1"),"legendPanel",_ref.getField(false, "_legendpanel"),"maxSales1",_ref.getField(false, "_maxsales1"),"pageNo",_ref.getField(false, "_pageno"),"paginationLabel",_ref.getField(false, "_paginationlabel"),"panel_l",_ref.getField(false, "_panel_l"),"product1",_ref.getField(false, "_product1"),"radioLabelLegendTitles",_ref.getField(false, "_radiolabellegendtitles"),"radioLabelSalesTitles",_ref.getField(false, "_radiolabelsalestitles"),"radioLabelSortTitles",_ref.getField(false, "_radiolabelsorttitles"),"radioPanel",_ref.getField(false, "_radiopanel"),"sale_1",_ref.getField(false, "_sale_1"),"sale_2",_ref.getField(false, "_sale_2"),"sale_3",_ref.getField(false, "_sale_3"),"salePanel",_ref.getField(false, "_salepanel"),"sales1",_ref.getField(false, "_sales1"),"sales2",_ref.getField(false, "_sales2"),"sales3",_ref.getField(false, "_sales3"),"showHideBtn",_ref.getField(false, "_showhidebtn"),"shownMainpanel",_ref.getField(false, "_shownmainpanel"),"sortBtn1",_ref.getField(false, "_sortbtn1"),"sortBtn2",_ref.getField(false, "_sortbtn2"),"sortMainpanel",_ref.getField(false, "_sortmainpanel"),"sortPanel",_ref.getField(false, "_sortpanel"),"titleString1",_ref.getField(false, "_titlestring1"),"totalPages",_ref.getField(false, "_totalpages")};
}
}