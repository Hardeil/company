...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Active1",_ref.getField(false, "_active1"),"checkBoxes",_ref.getField(false, "_checkboxes"),"checkedSales",_ref.getField(false, "_checkedsales"),"color",_ref.getField(false, "_color"),"legend1",_ref.getField(false, "_legend1"),"legendPanel",_ref.getField(false, "_legendpanel"),"maxSales1",_ref.getField(false, "_maxsales1"),"panel_l",_ref.getField(false, "_panel_l"),"product1",_ref.getField(false, "_product1"),"sale_1",_ref.getField(false, "_sale_1"),"sale_2",_ref.getField(false, "_sale_2"),"sale_3",_ref.getField(false, "_sale_3"),"titleString1",_ref.getField(false, "_titlestring1")};
}
}