...
bargraph.__c.runVoidMethod ("LogImpl","73473426",RemoteObject.createImmutable("Error: Sender is not a CheckBox"),0);
 };
...
Debug.ShouldStop(2);
bargraph.__c.runVoidMethod ("LogImpl","73014795",(RemoteObject.concat(RemoteObject.createImmutable("alignTopCenter:"),bargraph.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_aligntopcenter))),RemoteObject.createImmutable(""))),0);
...
Debug.ShouldStop(134217728);
bargraph.__c.runVoidMethod ("LogImpl","73014853",BA.ObjectToString(bargraph.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
Debug.ShouldStop(256);
bargraph.__c.runVoidMethod ("LogImpl","72949122",RemoteObject.createImmutable("Error: Activity is not initialized"),0);
...
Debug.ShouldStop(32768);
bargraph.__c.runVoidMethod ("LogImpl","73276803",RemoteObject.concat(RemoteObject.createImmutable("Selected Company ID: "),_selectedcompany),0);
