...
try {
		Debug.PushSubsStack("chkChange_CheckedChange (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,462);
...
bargraph.__c.runVoidMethod ("LogImpl","63014674",RemoteObject.createImmutable("Error: Sender is not a CheckBox"),0);
 };
...
try {
		Debug.PushSubsStack("DrawGraph (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,220);
...
_btnmainpanel.runVoidMethod ("AddView",(Object)((__ref.getField(false,"_showhidebtn" /*RemoteObject*/ ).getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_paginationpanel.runMethod(true,"getWidth"),bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))}, "+",1, 1)),(Object)(bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_btnmainpanel.runMethod(true,"getWidth"),_paginationpanel.runMethod(true,"getWidth")}, "-",1, 1)),bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 1)),(Object)(_buttonheight));
 BA.debugLineNum = 410;BA.debugLine="If hideShowBoolean = True Then";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_hideshowboolean" /*RemoteObject*/ ),bargraph.__c.getField(true,"True"))) { 
 BA.debugLineNum = 411;BA.debugLine="paginationPanel.Width = btnMainPanel.Width";
...
_paginationpanel.runMethod(true,"setWidth",_btnmainpanel.runMethod(true,"getWidth"));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e156.toString()); BA.debugLineNum = 417;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1);
bargraph.__c.runVoidMethod ("LogImpl","62556101",BA.ObjectToString(bargraph.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("FormatNumberWithLabel (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,453);
...
try {
		Debug.PushSubsStack("FormatNumberWithSuffix (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,443);
...
try {
		Debug.PushSubsStack("GetCheckedSales (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,484);
...
try {
		Debug.PushSubsStack("GetCurrentPage (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,425);
...
Debug.ShouldStop(2048);
bargraph.__c.runVoidMethod ("LogImpl","62490370",RemoteObject.createImmutable("Error: Activity is not initialized"),0);
...
{
final int step54 = 1;
final int limit54 = RemoteObject.solve(new RemoteObject[] {_legend.getField(true,"length"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
...
{
final int step70 = 1;
final int limit70 = RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_checkboxes" /*RemoteObject*/ ).getField(true,"length"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
...
{
final int step111 = 1;
final int limit111 = RemoteObject.solve(new RemoteObject[] {_totalbuttons,RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step111 > 0 && _i <= limit111) || (step111 < 0 && _i >= limit111) ;_i = ((int)(0 + _i + step111))  ) {
Debug.locals.put("i", _i);
...
{
final int step127 = 1;
final int limit127 = RemoteObject.solve(new RemoteObject[] {_totallabels,RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
...
try {
		Debug.PushSubsStack("productLabel_Click (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,434);
...
Debug.ShouldStop(1048576);
bargraph.__c.runVoidMethod ("LogImpl","62818051",RemoteObject.concat(RemoteObject.createImmutable("Selected Company ID: "),_selectedcompany),0);
...
try {
		Debug.PushSubsStack("SetCurrentPage (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,429);
...
try {
		Debug.PushSubsStack("UpdateGraph (bargraph) ","bargraph",2,__ref.getField(false, "ba"),__ref,421);
