...
Debug.ShouldStop(4096);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22490373",_index,0);
 BA.debugLineNum = 590;BA.debugLine="Log(\"(default)\")";
Debug.ShouldStop(8192);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22490374",RemoteObject.createImmutable("(default)"),0);
...
Debug.ShouldStop(4096);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21769480",RemoteObject.createImmutable("Invalid input values"),0);
 };
...
Debug.ShouldStop(1048576);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638480",RemoteObject.createImmutable("Error loading image"),0);
 };
...
Debug.ShouldStop(524288);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638671",RemoteObject.createImmutable("No branch data returned"),0);
...
Debug.ShouldStop(134217728);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638711",RemoteObject.createImmutable("Bar graph initialized"),0);
 }else {
...
Debug.ShouldStop(16);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638720",RemoteObject.createImmutable("Bar graph updated"),0);
 };
...
Debug.ShouldStop(65536);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638732",RemoteObject.concat(RemoteObject.createImmutable("Unknown job: "),_job.getField(true,"_jobname" /*RemoteObject*/ )),0);
 break; }
}
;
...
Debug.ShouldStop(1048576);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638736",RemoteObject.concat(RemoteObject.createImmutable("Error parsing data: "),branch.mostCurrent.__c.runMethod(false,"LastException",branch.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
...
Debug.ShouldStop(16777216);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21638740",RemoteObject.concat(RemoteObject.createImmutable("Job failed: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(8388608);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21507335",RemoteObject.concat(branch.mostCurrent._starter._company_selected /*RemoteObject*/ ,RemoteObject.createImmutable("id")),0);
...
Debug.ShouldStop(128);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21441799",RemoteObject.concat(branch.mostCurrent._starter._company_selected /*RemoteObject*/ ,RemoteObject.createImmutable("isd")),0);
...
Debug.ShouldStop(2048);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","21441803",branch.mostCurrent.__c.runMethod(false,"LastException",branch.mostCurrent.activityBA).runMethod(true,"getMessage"),0);
 };
...
Debug.ShouldStop(536870912);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22359298",BA.NumberToString(branch._currentpage),0);
...
Debug.ShouldStop(32768);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22686983",branch.mostCurrent._sortdefaultvalue,0);
 BA.debugLineNum = 625;BA.debugLine="Log(\" sales 1 Button clicked: \" & index)";
Debug.ShouldStop(65536);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22686984",RemoteObject.concat(RemoteObject.createImmutable(" sales 1 Button clicked: "),_index),0);
...
Debug.ShouldStop(67108864);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22752519",branch.mostCurrent._sortdefaultvalue,0);
 BA.debugLineNum = 636;BA.debugLine="Log(index)";
Debug.ShouldStop(134217728);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22752520",_index,0);
 BA.debugLineNum = 637;BA.debugLine="Log(\"(Sale2)\")";
Debug.ShouldStop(268435456);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22752521",RemoteObject.createImmutable("(Sale2)"),0);
...
Debug.ShouldStop(32);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22818055",branch.mostCurrent._sortdefaultvalue,0);
 BA.debugLineNum = 648;BA.debugLine="Log(index)";
Debug.ShouldStop(128);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22818057",_index,0);
 BA.debugLineNum = 649;BA.debugLine="Log(\"(Sale3)\")";
Debug.ShouldStop(256);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22818058",RemoteObject.createImmutable("(Sale3)"),0);
...
Debug.ShouldStop(16);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22621445",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),branch.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((branch.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
...
Debug.ShouldStop(67108864);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","22555909",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),branch.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((branch.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
