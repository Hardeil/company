...
Debug.ShouldStop(16);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43145733",_index,0);
 BA.debugLineNum = 582;BA.debugLine="Log(\"(default)\")";
Debug.ShouldStop(32);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43145734",RemoteObject.createImmutable("(default)"),0);
...
Debug.ShouldStop(16);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","42424840",RemoteObject.createImmutable("Invalid input values"),0);
 };
...
Debug.ShouldStop(32768);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","42293840",RemoteObject.createImmutable("Error loading image"),0);
 };
...
Debug.ShouldStop(16);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","42294085",(RemoteObject.concat(RemoteObject.createImmutable("Company: "),branch.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_name))),RemoteObject.createImmutable(" has no branches information."))),0);
 };
 };
 }
}Debug.locals.put("i", _i);
...
Debug.ShouldStop(1024);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","42294091",RemoteObject.concat(RemoteObject.createImmutable("Unknown job: "),_job.getField(true,"_jobname" /*RemoteObject*/ )),0);
 break; }
}
;
...
Debug.ShouldStop(128);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","42097160",branch.mostCurrent.__c.runMethod(false,"LastException",branch.mostCurrent.activityBA).runMethod(true,"getMessage"),0);
 };
...
Debug.ShouldStop(2097152);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43014658",BA.NumberToString(branch._currentpage),0);
...
Debug.ShouldStop(128);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43342343",branch.mostCurrent._sortdefaultvalue,0);
 BA.debugLineNum = 617;BA.debugLine="Log(\" sales 1 Button clicked: \" & index)";
Debug.ShouldStop(256);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43342344",RemoteObject.concat(RemoteObject.createImmutable(" sales 1 Button clicked: "),_index),0);
...
Debug.ShouldStop(262144);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43407879",branch.mostCurrent._sortdefaultvalue,0);
 BA.debugLineNum = 628;BA.debugLine="Log(index)";
Debug.ShouldStop(524288);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43407880",_index,0);
 BA.debugLineNum = 629;BA.debugLine="Log(\"(Sale2)\")";
Debug.ShouldStop(1048576);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43407881",RemoteObject.createImmutable("(Sale2)"),0);
...
Debug.ShouldStop(536870912);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43473415",branch.mostCurrent._sortdefaultvalue,0);
 BA.debugLineNum = 640;BA.debugLine="Log(index)";
Debug.ShouldStop(-2147483648);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43473417",_index,0);
 BA.debugLineNum = 641;BA.debugLine="Log(\"(Sale3)\")";
Debug.ShouldStop(1);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43473418",RemoteObject.createImmutable("(Sale3)"),0);
...
Debug.ShouldStop(268435456);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43276805",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),branch.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((branch.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
...
Debug.ShouldStop(262144);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","43211269",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),branch.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((branch.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
