...
try {
		Debug.PushSubsStack("chkChange_CheckedChange (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,79);
...
Debug.ShouldStop(1);
<<<<<<< HEAD
checkbargraph.__c.runVoidMethod ("LogImpl","63080210",RemoteObject.createImmutable("Error: Sender is not a CheckBox"),0);
=======
checkbargraph.__c.runVoidMethod ("LogImpl","02818066",RemoteObject.createImmutable("Error: Sender is not a CheckBox"),0);
...
try {
		Debug.PushSubsStack("DrawGraph (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,75);
...
try {
		Debug.PushSubsStack("DrawGraph1 (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("DrawWrappedTextRotated (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,285);
...
try {
		Debug.PushSubsStack("FormatNumberWithLabel (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,325);
...
try {
		Debug.PushSubsStack("FormatNumberWithSuffix (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,315);
...
try {
		Debug.PushSubsStack("Initialize (checkbargraph) ","checkbargraph",3,__ref.getField(false, "ba"),__ref,17);
