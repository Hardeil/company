...
try {
		Debug.PushSubsStack("Activity_Pause (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,356);
...
try {
		Debug.PushSubsStack("Activity_Resume (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,353);
...
try {
		Debug.PushSubsStack("backBtn_Click (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,162);
...
try {
		Debug.PushSubsStack("branch_Click (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,362);
...
try {
		Debug.PushSubsStack("home_Click (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,358);
...
try {
		Debug.PushSubsStack("JobDone (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,182);
...
Debug.ShouldStop(134217728);
device.mostCurrent.__c.runVoidMethod ("LogImpl","31114114",device.mostCurrent._phpurl,0);
...
try {
		Debug.PushSubsStack("nxtLabel_Click (device) ","device",2,device.mostCurrent.activityBA,device.mostCurrent,173);
