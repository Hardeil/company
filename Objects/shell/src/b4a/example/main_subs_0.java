...
try {
		Debug.PushSubsStack("Activity_Pause (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,301);
...
try {
		Debug.PushSubsStack("Activity_Resume (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,297);
...
try {
		Debug.PushSubsStack("GetMapValueOrDefault (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,289);
...
Debug.locals.put("DefaultValue", _defaultvalue);
 BA.debugLineNum = 289;BA.debugLine="Sub GetMapValueOrDefault(m As Map, Key As String,";
Debug.ShouldStop(1);
 BA.debugLineNum = 290;BA.debugLine="If m.ContainsKey(Key) Then";
Debug.ShouldStop(2);
if (_m.runMethod(true,"ContainsKey",(Object)((_key))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 291;BA.debugLine="Return m.Get(Key)";
Debug.ShouldStop(4);
if (true) return _m.runMethod(false,"Get",(Object)((_key)));
 }else {
 BA.debugLineNum = 293;BA.debugLine="Return DefaultValue";
Debug.ShouldStop(16);
...
int _j = 0;
RemoteObject _specificbranch = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
...
case 0: {
 BA.debugLineNum = 87;BA.debugLine="Dim scrollHeight As Int = 0";
Debug.ShouldStop(4194304);
_scrollheight = BA.numberCast(int.class, 0);Debug.locals.put("scrollHeight", _scrollheight);Debug.locals.put("scrollHeight", _scrollheight);
 BA.debugLineNum = 88;BA.debugLine="Dim salesArray As List = parser.NextArray";
Debug.ShouldStop(8388608);
...
_salesarray = _parser.runMethod(false,"NextArray");Debug.locals.put("salesArray", _salesarray);Debug.locals.put("salesArray", _salesarray);
 BA.debugLineNum = 92;BA.debugLine="If salesArray.Size = 0 Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",_salesarray.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 93;BA.debugLine="ToastMessageShow(\"No data received\", True)";
Debug.ShouldStop(268435456);
...
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 98;BA.debugLine="Dim numColumns As Int = 2 ' Adjust based on p";
Debug.ShouldStop(2);
_numcolumns = BA.numberCast(int.class, 2);Debug.locals.put("numColumns", _numcolumns);Debug.locals.put("numColumns", _numcolumns);
 BA.debugLineNum = 99;BA.debugLine="Dim pnlWidth As Int = Activity.Width - 100dip";
Debug.ShouldStop(4);
_pnlwidth = RemoteObject.solve(new RemoteObject[] {main.mostCurrent._activity.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)))}, "-",1, 1);Debug.locals.put("pnlWidth", _pnlwidth);Debug.locals.put("pnlWidth", _pnlwidth);
 BA.debugLineNum = 100;BA.debugLine="Dim pnlHeight As Int = 280dip";
Debug.ShouldStop(8);
_pnlheight = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 280)));Debug.locals.put("pnlHeight", _pnlheight);Debug.locals.put("pnlHeight", _pnlheight);
 BA.debugLineNum = 101;BA.debugLine="Dim padding As Int = 10dip";
Debug.ShouldStop(16);
_padding = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("padding", _padding);Debug.locals.put("padding", _padding);
 BA.debugLineNum = 102;BA.debugLine="Dim leftPosition As Int = 50dip";
Debug.ShouldStop(32);
_leftposition = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 50)));Debug.locals.put("leftPosition", _leftposition);Debug.locals.put("leftPosition", _leftposition);
 BA.debugLineNum = 103;BA.debugLine="Dim topPosition As Int = 77dip";
Debug.ShouldStop(64);
...
_pnlwidth = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 490)));Debug.locals.put("pnlWidth", _pnlwidth);
 BA.debugLineNum = 107;BA.debugLine="pnlHeight = 300dip";
Debug.ShouldStop(1024);
_pnlheight = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 300)));Debug.locals.put("pnlHeight", _pnlheight);
 BA.debugLineNum = 108;BA.debugLine="padding = 10dip";
...
_padding = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("padding", _padding);
 BA.debugLineNum = 109;BA.debugLine="leftPosition = 10dip";
Debug.ShouldStop(4096);
_leftposition = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("leftPosition", _leftposition);
 ...
 BA.debugLineNum = 112;BA.debugLine="For Each record As Map In salesArray";
Debug.ShouldStop(32768);
...
Debug.locals.put("record", _record);
 BA.debugLineNum = 113;BA.debugLine="Dim name As String = record.Get(\"company_nam";
Debug.ShouldStop(65536);
_name = BA.ObjectToString(_record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("company_name")))));Debug.locals.put("name", _name);Debug.locals.put("name", _name);
 BA.debugLineNum = 114;BA.debugLine="Dim company_id As Int = record.Get(\"comId\")";
Debug.ShouldStop(131072);
_company_id = BA.numberCast(int.class, _record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("comId")))));Debug.locals.put("company_id", _company_id);Debug.locals.put("company_id", _company_id);
 BA.debugLineNum = 115;BA.debugLine="Dim total_count As Int = record.Get(\"total_c";
Debug.ShouldStop(262144);
_total_count = BA.numberCast(int.class, _record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("total_count")))));Debug.locals.put("total_count", _total_count);Debug.locals.put("total_count", _total_count);
 BA.debugLineNum = 116;BA.debugLine="Dim total_pos As Int = record.Get(\"totalDevi";
Debug.ShouldStop(524288);
...
_panel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("Panel")));
 BA.debugLineNum = 121;BA.debugLine="ScrollView1.Panel.AddView(Panel, leftPositio";
Debug.ShouldStop(16777216);
...
main.mostCurrent._panel2.runVoidMethod ("AddView",(Object)((_label17.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent._panel2.runMethod(true,"getWidth")),(Object)(main.mostCurrent._panel2.runMethod(true,"getHeight")));
 BA.debugLineNum = 143;BA.debugLine="Dim myImage As Bitmap";
Debug.ShouldStop(16384);
_myimage = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");Debug.locals.put("myImage", _myimage);
 BA.debugLineNum = 144;BA.debugLine="myImage = LoadBitmap(File.DirAssets, \"arrows";
Debug.ShouldStop(32768);
_myimage = main.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("arrows-removebg-preview.png")));Debug.locals.put("myImage", _myimage);
 BA.debugLineNum = 145;BA.debugLine="If myImage.IsInitialized Then";
Debug.ShouldStop(65536);
if (_myimage.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 146;BA.debugLine="Dim resizedImage As Bitmap = myImage.Resize";
Debug.ShouldStop(131072);
...
main.mostCurrent._panel2.runVoidMethod ("AddView",(Object)((_imgview.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._panel2.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 8)),main.mostCurrent.activityBA)}, "-",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 10)),main.mostCurrent.activityBA)),(Object)(main.mostCurrent._panel2.runMethod(true,"getHeight")));
 ...
 BA.debugLineNum = 152;BA.debugLine="Log(\"Error loading image\")";
Debug.ShouldStop(8388608);
main.mostCurrent.__c.runVoidMethod ("LogImpl","2262217",RemoteObject.createImmutable("Error loading image"),0);
 };
 BA.debugLineNum = 155;BA.debugLine="Dim panelWidth As Int = Panel.Width /3";
...
Debug.ShouldStop(134217728);
_padding = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("padding", _padding);Debug.locals.put("padding", _padding);
 BA.debugLineNum = 157;BA.debugLine="Dim labelheight As Int = 35dip";
Debug.ShouldStop(268435456);
_labelheight = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 35)));Debug.locals.put("labelheight", _labelheight);Debug.locals.put("labelheight", _labelheight);
 BA.debugLineNum = 160;BA.debugLine="panelWidth = Panel.Width /2";
Debug.ShouldStop(-2147483648);
...
_totalstorelabel.runMethod(true,"setText",BA.ObjectToCharSequence(_totalstorelabel.runMethod(true,"getText").runMethod(true,"toUpperCase")));
 BA.debugLineNum = 179;BA.debugLine="Panel.AddView(totalStoreLabel,0,totalStore.t";
Debug.ShouldStop(262144);
...
_panel.runVoidMethod ("AddView",(Object)((_totalpos.getObject())),(Object)(_panelwidth),(Object)(RemoteObject.solve(new RemoteObject[] {_totalstorelabel.runMethod(true,"getHeight"),_padding,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 160)))}, "++",2, 1)),(Object)(_panelwidth),(Object)(_labelheight));
 BA.debugLineNum = 190;BA.debugLine="Dim totalPosLabel As Label";
Debug.ShouldStop(536870912);
...
_totalposlabel.runMethod(true,"setText",BA.ObjectToCharSequence(_totalposlabel.runMethod(true,"getText").runMethod(true,"toUpperCase")));
 BA.debugLineNum = 198;BA.debugLine="Panel.AddView(totalPosLabel,panelWidth,total";
Debug.ShouldStop(32);
_panel.runVoidMethod ("AddView",(Object)((_totalposlabel.getObject())),(Object)(_panelwidth),(Object)(RemoteObject.solve(new RemoteObject[] {_totalpos.runMethod(true,"getTop"),_padding,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20)))}, "++",2, 1)),(Object)(_panelwidth),(Object)(_labelheight));
 BA.debugLineNum = 202;BA.debugLine="Dim branchName As String";
Debug.ShouldStop(512);
_branchname = RemoteObject.createImmutable("");Debug.locals.put("branchName", _branchname);
 BA.debugLineNum = 203;BA.debugLine="Dim branchSales1 As Int";
Debug.ShouldStop(1024);
_branchsales1 = RemoteObject.createImmutable(0);Debug.locals.put("branchSales1", _branchsales1);
 BA.debugLineNum = 204;BA.debugLine="Dim branchSales2 As Int";
Debug.ShouldStop(2048);
_branchsales2 = RemoteObject.createImmutable(0);Debug.locals.put("branchSales2", _branchsales2);
 BA.debugLineNum = 205;BA.debugLine="Dim branchSales3 As Int";
Debug.ShouldStop(4096);
_branchsales3 = RemoteObject.createImmutable(0);Debug.locals.put("branchSales3", _branchsales3);
 BA.debugLineNum = 206;BA.debugLine="If record.ContainsKey(\"branches\") Then";
Debug.ShouldStop(8192);
if (_record.runMethod(true,"ContainsKey",(Object)((RemoteObject.createImmutable("branches")))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 207;BA.debugLine="Dim branches As List = record.Get(\"branches";
Debug.ShouldStop(16384);
...
_branches = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("branches")))));Debug.locals.put("branches", _branches);Debug.locals.put("branches", _branches);
 BA.debugLineNum = 208;BA.debugLine="For j = 0 To branches.Size - 1";
Debug.ShouldStop(32768);
{
final int step106 = 1;
final int limit106 = RemoteObject.solve(new RemoteObject[] {_branches.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_j = 0 ;
for (;(step106 > 0 && _j <= limit106) || (step106 < 0 && _j >= limit106) ;_j = ((int)(0 + _j + step106))  ) {
Debug.locals.put("j", _j);
 BA.debugLineNum = 209;BA.debugLine="Dim specificbranch As Map = branches.Get(j";
Debug.ShouldStop(65536);
_specificbranch = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_specificbranch = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _branches.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _j))));Debug.locals.put("specificbranch", _specificbranch);Debug.locals.put("specificbranch", _specificbranch);
 BA.debugLineNum = 210;BA.debugLine="branchName = GetMapValueOrDefault(specific";
Debug.ShouldStop(131072);
_branchname = BA.ObjectToString(_getmapvalueordefault(_specificbranch,BA.ObjectToString("branch_name"),(RemoteObject.createImmutable("Unknown Branch"))));Debug.locals.put("branchName", _branchname);
 BA.debugLineNum = 211;BA.debugLine="branchSales1 = GetMapValueOrDefault(specif";
Debug.ShouldStop(262144);
_branchsales1 = BA.numberCast(int.class, _getmapvalueordefault(_specificbranch,BA.ObjectToString("sales1"),RemoteObject.createImmutable((0))));Debug.locals.put("branchSales1", _branchsales1);
 BA.debugLineNum = 212;BA.debugLine="branchSales2  = GetMapValueOrDefault(speci";
Debug.ShouldStop(524288);
_branchsales2 = BA.numberCast(int.class, _getmapvalueordefault(_specificbranch,BA.ObjectToString("sales2"),RemoteObject.createImmutable((0))));Debug.locals.put("branchSales2", _branchsales2);
 BA.debugLineNum = 213;BA.debugLine="branchSales3= GetMapValueOrDefault(specifi";
Debug.ShouldStop(1048576);
_branchsales3 = BA.numberCast(int.class, _getmapvalueordefault(_specificbranch,BA.ObjectToString("sales3"),RemoteObject.createImmutable((0))));Debug.locals.put("branchSales3", _branchsales3);
 BA.debugLineNum = 215;BA.debugLine="Log($\"Company: ${name}, Branch: ${branchNa";
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("LogImpl","2262280",(RemoteObject.concat(RemoteObject.createImmutable("Company: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_name))),RemoteObject.createImmutable(", Branch: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_branchname))),RemoteObject.createImmutable(", Sales1: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_branchsales1))),RemoteObject.createImmutable(", Sales2: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_branchsales2))),RemoteObject.createImmutable(", Sales3: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_branchsales3))),RemoteObject.createImmutable(""))),0);
 }
}Debug.locals.put("j", _j);
;
 }else {
 BA.debugLineNum = 218;BA.debugLine="Log($\"Company: ${name} has no branches info";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("LogImpl","2262283",(RemoteObject.concat(RemoteObject.createImmutable("Company: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_name))),RemoteObject.createImmutable(" has no branches information."))),0);
 };
 BA.debugLineNum = 221;BA.debugLine="If Activity.Width >= 1340 Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("g",main.mostCurrent._activity.runMethod(true,"getWidth"),BA.numberCast(double.class, 1340))) { 
 BA.debugLineNum = 222;BA.debugLine="count = count + 1";
Debug.ShouldStop(536870912);
_count = RemoteObject.solve(new RemoteObject[] {_count,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("count", _count);
 BA.debugLineNum = 223;BA.debugLine="If count Mod numColumns = 0 Then";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("=",RemoteObject.solve(new RemoteObject[] {_count,_numcolumns}, "%",0, 1),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 225;BA.debugLine="leftPosition = 10dip";
Debug.ShouldStop(1);
_leftposition = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("leftPosition", _leftposition);
 BA.debugLineNum = 226;BA.debugLine="topPosition = topPosition + pnlHeight + pa";
Debug.ShouldStop(2);
_topposition = RemoteObject.solve(new RemoteObject[] {_topposition,_pnlheight,_padding}, "++",2, 1);Debug.locals.put("topPosition", _topposition);
 ...
 BA.debugLineNum = 229;BA.debugLine="leftPosition = leftPosition + pnlWidth + p";
Debug.ShouldStop(16);
_leftposition = RemoteObject.solve(new RemoteObject[] {_leftposition,_pnlwidth,_padding}, "++",2, 1);Debug.locals.put("leftPosition", _leftposition);
 ...
 BA.debugLineNum = 231;BA.debugLine="scrollHeight = scrollHeight + 175dip";
Debug.ShouldStop(64);
_scrollheight = RemoteObject.solve(new RemoteObject[] {_scrollheight,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 175)))}, "+",1, 1);Debug.locals.put("scrollHeight", _scrollheight);
 ...
 BA.debugLineNum = 233;BA.debugLine="topPosition = topPosition + pnlHeight + pad";
Debug.ShouldStop(256);
_topposition = RemoteObject.solve(new RemoteObject[] {_topposition,_pnlheight,_padding}, "++",2, 1);Debug.locals.put("topPosition", _topposition);
 BA.debugLineNum = 234;BA.debugLine="scrollHeight = scrollHeight + 300dip + padd";
Debug.ShouldStop(512);
...
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 239;BA.debugLine="cd.Initialize2(Colors.White, 0dip, 1dip, Col";
Debug.ShouldStop(16384);
_cd.runVoidMethod ("Initialize2",(Object)(main.mostCurrent.__c.getField(false,"Colors").getField(true,"White")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1)))),(Object)(main.mostCurrent.__c.getField(false,"Colors").getField(true,"Black")));
 BA.debugLineNum = 240;BA.debugLine="Panel.Background = cd";
Debug.ShouldStop(32768);
_panel.runMethod(false,"setBackground",(_cd.getObject()));
 }
}Debug.locals.put("record", _record);
;
 BA.debugLineNum = 243;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
Debug.ShouldStop(262144);
_totalcompanies = _salesarray.runMethod(true,"getSize");Debug.locals.put("totalCompanies", _totalcompanies);Debug.locals.put("totalCompanies", _totalcompanies);
 BA.debugLineNum = 244;BA.debugLine="Dim sales(totalCompanies) As Int";
Debug.ShouldStop(524288);
_sales = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("sales", _sales);
 BA.debugLineNum = 245;BA.debugLine="Dim sales1(totalCompanies) As Int";
Debug.ShouldStop(1048576);
_sales1 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("sales1", _sales1);
 BA.debugLineNum = 246;BA.debugLine="Dim sales2(totalCompanies) As Int";
Debug.ShouldStop(2097152);
_sales2 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("sales2", _sales2);
 BA.debugLineNum = 247;BA.debugLine="Dim purchase(totalCompanies) As Int";
Debug.ShouldStop(4194304);
_purchase = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase", _purchase);
 BA.debugLineNum = 248;BA.debugLine="Dim purchase1(totalCompanies) As Int";
Debug.ShouldStop(8388608);
_purchase1 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase1", _purchase1);
 BA.debugLineNum = 249;BA.debugLine="Dim purchase2(totalCompanies) As Int";
Debug.ShouldStop(16777216);
_purchase2 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase2", _purchase2);
 BA.debugLineNum = 250;BA.debugLine="Dim companyName(totalCompanies) As String";
Debug.ShouldStop(33554432);
_companyname = RemoteObject.createNewArray ("String", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("companyName", _companyname);
 BA.debugLineNum = 255;BA.debugLine="For i = 0 To totalCompanies - 1";
Debug.ShouldStop(1073741824);
{
final int step142 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 256;BA.debugLine="Dim record As Map = salesArray.Get(i)";
Debug.ShouldStop(-2147483648);
_record = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_record = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _salesarray.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("record", _record);Debug.locals.put("record", _record);
 BA.debugLineNum = 257;BA.debugLine="companyName(i) = record.GetDefault(\"company_";
Debug.ShouldStop(1);
_companyname.setArrayElement (BA.ObjectToString(_record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("company_name"))),(Object)((RemoteObject.createImmutable("Unknown"))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 258;BA.debugLine="sales(i) = record.GetDefault(\"sales_1\", 0)";
Debug.ShouldStop(2);
_sales.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("sales_1"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 259;BA.debugLine="sales1(i) = record.GetDefault(\"sales_2\", 0)";
Debug.ShouldStop(4);
_sales1.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("sales_2"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 260;BA.debugLine="sales2(i) = record.GetDefault(\"sales_3\", 0)";
Debug.ShouldStop(8);
_sales2.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("sales_3"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 261;BA.debugLine="purchase(i) = record.GetDefault(\"purchase_1\"";
Debug.ShouldStop(16);
_purchase.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_1"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 262;BA.debugLine="purchase1(i) = record.GetDefault(\"purchase_2";
Debug.ShouldStop(32);
_purchase1.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_2"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 263;BA.debugLine="purchase2(i) = record.GetDefault(\"purchase_\"";
Debug.ShouldStop(64);
...
;
 BA.debugLineNum = 267;BA.debugLine="barPanel.RemoveAllViews";
Debug.ShouldStop(1024);
main.mostCurrent._barpanel.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 268;BA.debugLine="barPanel.Invalidate ' Force redraw";
Debug.ShouldStop(2048);
main.mostCurrent._barpanel.runVoidMethod ("Invalidate");
 BA.debugLineNum = 270;BA.debugLine="Dim legend() As String = Array As String(\"Sal";
Debug.ShouldStop(8192);
main.mostCurrent._legend = RemoteObject.createNewArray("String",new int[] {3},new Object[] {BA.ObjectToString("Sales1"),BA.ObjectToString("Sales2"),RemoteObject.createImmutable("Sales3")});
 BA.debugLineNum = 271;BA.debugLine="barGraph.Initialize(Activity, barPanel, sales";
Debug.ShouldStop(16384);
main.mostCurrent._bargraph.runClassMethod (b4a.example.bargraph.class, "_initialize" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._activity),(Object)(main.mostCurrent._barpanel),(Object)(_sales),(Object)(_sales1),(Object)(_sales2),(Object)(_companyname),(Object)(main.mostCurrent._legend),(Object)(BA.numberCast(int.class, 10000)),(Object)(RemoteObject.createImmutable("Total Sales of the Company")));
 BA.debugLineNum = 272;BA.debugLine="legend = Array As String(\"Purchase1\",\"Purchas";
Debug.ShouldStop(32768);
main.mostCurrent._legend = RemoteObject.createNewArray("String",new int[] {3},new Object[] {BA.ObjectToString("Purchase1"),BA.ObjectToString("Purchase2"),RemoteObject.createImmutable("Purchase3")});
 BA.debugLineNum = 273;BA.debugLine="barGraph1.Initialize(Activity, purchasePanel,";
Debug.ShouldStop(65536);
main.mostCurrent._bargraph1.runClassMethod (b4a.example.bargraph.class, "_initialize" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._activity),(Object)(main.mostCurrent._purchasepanel),(Object)(_purchase),(Object)(_purchase1),(Object)(_purchase2),(Object)(_companyname),(Object)(main.mostCurrent._legend),(Object)(BA.numberCast(int.class, 10000)),(Object)(RemoteObject.createImmutable("Total Purchase of the Company")));
 break; }
case 1: {
 BA.debugLineNum = 276;BA.debugLine="ToastMessageShow(\"Data updated successfully\",";
Debug.ShouldStop(524288);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Data updated successfully")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 277;BA.debugLine="LoadCompanyData";
Debug.ShouldStop(1048576);
_loadcompanydata();
 break; }
default: {
 BA.debugLineNum = 279;BA.debugLine="Log(\"Unknown job: \" & job.JobName)";
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("LogImpl","2262344",RemoteObject.concat(RemoteObject.createImmutable("Unknown job: "),_job.getField(true,"_jobname" /*RemoteObject*/ )),0);
 break; }
}
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e165.toString()); BA.debugLineNum = 282;BA.debugLine="ToastMessageShow(\"Error parsing sales data\", Tr";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Error parsing sales data")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 ...
 BA.debugLineNum = 285;BA.debugLine="ToastMessageShow(\"Error: \" & job.ErrorMessage, T";
Debug.ShouldStop(268435456);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )))),(Object)(main.mostCurrent.__c.getField(true,"True")));
 ...
 BA.debugLineNum = 287;BA.debugLine="job.Release";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("Label17_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,306);
...
RemoteObject _selectedcompany = RemoteObject.createImmutable("");
 BA.debugLineNum = 306;BA.debugLine="Private Sub Label17_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 307;BA.debugLine="Dim clickedLabel As Label = Sender ' Get the clic";
Debug.ShouldStop(262144);
...
_clickedlabel = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("clickedLabel", _clickedlabel);Debug.locals.put("clickedLabel", _clickedlabel);
 BA.debugLineNum = 308;BA.debugLine="Dim selectedCompany As String = clickedLabel.Tag";
Debug.ShouldStop(524288);
_selectedcompany = BA.ObjectToString(_clickedlabel.runMethod(false,"getTag"));Debug.locals.put("selectedCompany", _selectedcompany);Debug.locals.put("selectedCompany", _selectedcompany);
 BA.debugLineNum = 310;BA.debugLine="Starter.company_selected = selectedCompany";
Debug.ShouldStop(2097152);
main.mostCurrent._starter._company_selected /*RemoteObject*/  = _selectedcompany;
 BA.debugLineNum = 313;BA.debugLine="StartActivity(\"Branch\")";
Debug.ShouldStop(16777216);
