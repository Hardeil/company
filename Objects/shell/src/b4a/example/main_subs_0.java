...
Debug.ShouldStop(8);
 BA.debugLineNum = 69;BA.debugLine="Activity.LoadLayout(\"Layout\")";
Debug.ShouldStop(16);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout")),main.mostCurrent.activityBA);
 BA.debugLineNum = 70;BA.debugLine="Panel1.Color = Colors.Black";
Debug.ShouldStop(32);
main.mostCurrent._panel1.runVoidMethod ("setColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 71;BA.debugLine="Label1.Text = Label1.Text.ToUpperCase";
Debug.ShouldStop(64);
main.mostCurrent._label1.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._label1.runMethod(true,"getText").runMethod(true,"toUpperCase")));
 BA.debugLineNum = 72;BA.debugLine="Label1.Typeface = Typeface.MONOSPACE";
...
main.mostCurrent._label1.runMethod(false,"setTypeface",main.mostCurrent.__c.getField(false,"Typeface").getField(false,"MONOSPACE"));
 BA.debugLineNum = 73;BA.debugLine="ScrollView1.Panel.Color = Colors.ARGB(255, 241, 2";
...
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("setColor",main.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 241)),(Object)(BA.numberCast(int.class, 241)),(Object)(BA.numberCast(int.class, 241))));
 BA.debugLineNum = 74;BA.debugLine="Dim gradient As GradientDrawable";
...
_gradient = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gradient", _gradient);
 BA.debugLineNum = 75;BA.debugLine="gradient.Initialize(\"RIGHT_LEFT\", Array As Int(Co";
...
_gradient.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"RIGHT_LEFT")),(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {main.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 225)),(Object)(BA.numberCast(int.class, 218)),(Object)(BA.numberCast(int.class, 218))),main.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 189)),(Object)(BA.numberCast(int.class, 202)),(Object)(BA.numberCast(int.class, 217)))})));
 BA.debugLineNum = 76;BA.debugLine="ScrollView1.Background = gradient";
Debug.ShouldStop(2048);
main.mostCurrent._scrollview1.runMethod(false,"setBackground",(_gradient.getObject()));
 BA.debugLineNum = 77;BA.debugLine="ScrollView1.Panel.Height = Activity.Height";
...
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runMethod(true,"setHeight",main.mostCurrent._activity.runMethod(true,"getHeight"));
 BA.debugLineNum = 78;BA.debugLine="Dim gradient As GradientDrawable";
Debug.ShouldStop(8192);
_gradient = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gradient", _gradient);
 BA.debugLineNum = 79;BA.debugLine="gradient.Initialize(\"RIGHT_LEFT\", Array As Int(Co";
...
main.mostCurrent._barpanel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 84;BA.debugLine="purchasePanel.Initialize(\"\")";
...
main.mostCurrent._purchasepanel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 85;BA.debugLine="companyPanel.Initialize(\"Panel\")";
...
main.mostCurrent._companypanel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("Panel")));
 BA.debugLineNum = 87;BA.debugLine="LoadCompanyData";
Debug.ShouldStop(4194304);
_loadcompanydata();
 BA.debugLineNum = 88;BA.debugLine="LoadGraphData";
Debug.ShouldStop(8388608);
_loadgraphdata();
 BA.debugLineNum = 89;BA.debugLine="LoadGraphDataPurchase";
...
try {
		Debug.PushSubsStack("Activity_Pause (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,440);
if (RapidSub.canDelegate("activity_pause")) { return b4a.example.main.remoteMe.runUserSub(false, "main","activity_pause", _userclosed);}
Debug.locals.put("UserClosed", _userclosed);
 BA.debugLineNum = 440;BA.debugLine="Sub Activity_Pause(UserClosed As Boolean)";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("Activity_Resume (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,437);
...
try {
		Debug.PushSubsStack("AdjustFontSizeToHeight (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,665);
...
Debug.locals.put("fontScaleFactor", _fontscalefactor);
 BA.debugLineNum = 665;BA.debugLine="Sub AdjustFontSizeToHeight(lbl As Label, fontScale";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 666;BA.debugLine="Dim fontSize As Float = lbl.Height * fontScaleFac";
Debug.ShouldStop(33554432);
_fontsize = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_lbl.runMethod(true,"getHeight"),_fontscalefactor,_getdevicedensity()}, "*/",0, 0));Debug.locals.put("fontSize", _fontsize);Debug.locals.put("fontSize", _fontsize);
 BA.debugLineNum = 667;BA.debugLine="lbl.TextSize = fontSize ' Apply the size directly";
Debug.ShouldStop(67108864);
_lbl.runMethod(true,"setTextSize",_fontsize);
 BA.debugLineNum = 668;BA.debugLine="Return fontSize";
...
Debug.ShouldStop(262144);
 BA.debugLineNum = 532;BA.debugLine="sortDefaultValue = \"\"";
Debug.ShouldStop(524288);
main.mostCurrent._sortdefaultvalue = BA.ObjectToString("");
 BA.debugLineNum = 533;BA.debugLine="Log(\"Default sorting applied\")";
Debug.ShouldStop(1048576);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5851970",RemoteObject.createImmutable("Default sorting applied"),0);
 BA.debugLineNum = 534;BA.debugLine="LoadGraphData";
Debug.ShouldStop(2097152);
_loadgraphdata();
...
try {
		Debug.PushSubsStack("defBtnPurchase_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,537);
if (RapidSub.canDelegate("defbtnpurchase_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","defbtnpurchase_click");}
 BA.debugLineNum = 537;BA.debugLine="Sub defBtnPurchase_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 538;BA.debugLine="sortDefaultValue = \"\"";
Debug.ShouldStop(33554432);
main.mostCurrent._sortdefaultvalue = BA.ObjectToString("");
 BA.debugLineNum = 539;BA.debugLine="Log(\"Default sorting applied for purchases\")";
Debug.ShouldStop(67108864);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5917506",RemoteObject.createImmutable("Default sorting applied for purchases"),0);
 BA.debugLineNum = 540;BA.debugLine="LoadGraphDataPurchase";
Debug.ShouldStop(134217728);
_loadgraphdatapurchase();
...
try {
		Debug.PushSubsStack("GetDeviceDensity (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,671);
...
RemoteObject _dipwidth = RemoteObject.createImmutable(0);
 BA.debugLineNum = 671;BA.debugLine="Sub GetDeviceDensity As Float";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 672;BA.debugLine="Dim pixelWidth As Int = 100%x";
...
_pixelwidth = main.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 100)),main.mostCurrent.activityBA);Debug.locals.put("pixelWidth", _pixelwidth);Debug.locals.put("pixelWidth", _pixelwidth);
 BA.debugLineNum = 673;BA.debugLine="Dim dipWidth As Int = 100dip";
Debug.ShouldStop(1);
_dipwidth = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)));Debug.locals.put("dipWidth", _dipwidth);Debug.locals.put("dipWidth", _dipwidth);
 BA.debugLineNum = 674;BA.debugLine="Return pixelWidth / dipWidth";
Debug.ShouldStop(2);
...
main.mostCurrent._phpurl = BA.ObjectToString("https://192.168.8.117/Company/controller/company.php?action=get_company_list&page=1");
 //BA.debugLineNum = 23;BA.debugLine="Dim TableDetails As List";
...
main.mostCurrent._button1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 25;BA.debugLine="Private navigate As Label";
main.mostCurrent._navigate = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");
 //BA.debugLineNum = 26;BA.debugLine="Dim primaryFontSize As Int = 1.4%y";
main._primaryfontsize = main.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 1.4)),main.mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="Dim secondaryFontSize As Int = 1%y";
...
main.mostCurrent._panel2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
 //BA.debugLineNum = 31;BA.debugLine="Dim barGraph As barGraph ' Corrected casing";
main.mostCurrent._bargraph = RemoteObject.createNew ("b4a.example.bargraph");
 //BA.debugLineNum = 32;BA.debugLine="Dim barGraphPurchase As barGraph ' Renamed for co";
...
main.mostCurrent._sortbtnpurchase1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
 //BA.debugLineNum = 41;BA.debugLine="Dim sortBtnPurchase2 As RadioButton";
...
main.mostCurrent._defbtnpurchase = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
 //BA.debugLineNum = 49;BA.debugLine="Public purch1btn As RadioButton ' Added for purch";
main.mostCurrent._purch1btn = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
 //BA.debugLineNum = 50;BA.debugLine="Public purch2btn As RadioButton";
main.mostCurrent._purch2btn = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
 //BA.debugLineNum = 51;BA.debugLine="Public purch3btn As RadioButton";
main.mostCurrent._purch3btn = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
 //BA.debugLineNum = 52;BA.debugLine="Public showDetailButton As RadioButton";
main.mostCurrent._showdetailbutton = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
 //BA.debugLineNum = 53;BA.debugLine="Public legend() As String = Array As String(\"Sale";
main.mostCurrent._legend = RemoteObject.createNewArray("String",new int[] {3},new Object[] {BA.ObjectToString("Sales1"),BA.ObjectToString("Sales2"),RemoteObject.createImmutable("Sales3")});
 //BA.debugLineNum = 54;BA.debugLine="Public legendPurchase() As String = Array As Stri";
main.mostCurrent._legendpurchase = RemoteObject.createNewArray("String",new int[] {3},new Object[] {BA.ObjectToString("Purchase1"),BA.ObjectToString("Purchase2"),RemoteObject.createImmutable("Purchase3")});
 //BA.debugLineNum = 55;BA.debugLine="Dim height As Int = 0";
main._height = BA.numberCast(int.class, 0);
 //BA.debugLineNum = 56;BA.debugLine="Dim companyPanel As Panel";
main.mostCurrent._companypanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
 //BA.debugLineNum = 57;BA.debugLine="Dim totalGraphDataHeight As Int = 0";
main._totalgraphdataheight = BA.numberCast(int.class, 0);
 //BA.debugLineNum = 58;BA.debugLine="Dim totalGetDataHeight As Int = 0";
main._totalgetdataheight = BA.numberCast(int.class, 0);
 //BA.debugLineNum = 59;BA.debugLine="Dim sortDefaultValue As String = \"\"";
main.mostCurrent._sortdefaultvalue = BA.ObjectToString("");
 //BA.debugLineNum = 60;BA.debugLine="Dim salesData1 As Int = 1";
main._salesdata1 = BA.numberCast(int.class, 1);
 //BA.debugLineNum = 61;BA.debugLine="Dim currentPage As Int = 1";
main._currentpage = BA.numberCast(int.class, 1);
 //BA.debugLineNum = 62;BA.debugLine="Dim barGraphInitialized As Boolean = False";
main._bargraphinitialized = main.mostCurrent.__c.getField(true,"False");
 //BA.debugLineNum = 63;BA.debugLine="Dim barGraphInitializedPurchase As Boolean = Fals";
main._bargraphinitializedpurchase = main.mostCurrent.__c.getField(true,"False");
 //BA.debugLineNum = 64;BA.debugLine="Dim PHPURLCompany As String = $\"https://192.168.8";
main.mostCurrent._phpurlcompany = (RemoteObject.concat(RemoteObject.createImmutable("https://192.168.8.117/Company/controller/company.php?action=get_company_list&page="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._currentpage))),RemoteObject.createImmutable("&company_sales="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._salesdata1))),RemoteObject.createImmutable("&company_type="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable("")));
 //BA.debugLineNum = 65;BA.debugLine="Dim calculatedSize As Float = 0";
...
try {
		Debug.PushSubsStack("JobDone (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,129);
...
Debug.ShouldStop(1);
 BA.debugLineNum = 130;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(2);
...
Debug.ShouldStop(8);
try { BA.debugLineNum = 133;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(16);
_parser = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 134;BA.debugLine="parser.Initialize(job.GetString)";
Debug.ShouldStop(32);
_parser.runVoidMethod ("Initialize",(Object)(_job.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ )));
 BA.debugLineNum = 136;BA.debugLine="Select Case job.JobName";
Debug.ShouldStop(128);
switch (BA.switchObjectToInt(_job.getField(true,"_jobname" /*RemoteObject*/ ),BA.ObjectToString("GetData"),BA.ObjectToString("GetCompany"),BA.ObjectToString("GetCompanyPurchase"),BA.ObjectToString("UpdateData"))) {
case 0: {
 BA.debugLineNum = 138;BA.debugLine="Dim salesArray As List = parser.NextArray";
Debug.ShouldStop(512);
...
_salesarray = _parser.runMethod(false,"NextArray");Debug.locals.put("salesArray", _salesarray);Debug.locals.put("salesArray", _salesarray);
 BA.debugLineNum = 139;BA.debugLine="If salesArray.Size = 0 Then";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",_salesarray.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 140;BA.debugLine="ToastMessageShow(\"No data received\", True)";
Debug.ShouldStop(2048);
...
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 143;BA.debugLine="Dim padding As Int = 10dip";
Debug.ShouldStop(16384);
...
_mainpanelwidth = BA.numberCast(int.class, 0);Debug.locals.put("mainPanelWidth", _mainpanelwidth);Debug.locals.put("mainPanelWidth", _mainpanelwidth);
 BA.debugLineNum = 147;BA.debugLine="Dim panelHeight As Int = 150dip";
Debug.ShouldStop(262144);
_panelheight = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 150)));Debug.locals.put("panelHeight", _panelheight);Debug.locals.put("panelHeight", _panelheight);
 BA.debugLineNum = 148;BA.debugLine="height = panelHeight - 70dip";
Debug.ShouldStop(524288);
main._height = RemoteObject.solve(new RemoteObject[] {_panelheight,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 70)))}, "-",1, 1);
 BA.debugLineNum = 149;BA.debugLine="For Each record As Map In salesArray";
Debug.ShouldStop(1048576);
_record = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
{
final RemoteObject group19 = _salesarray;
final int groupLen19 = group19.runMethod(true,"getSize").<Integer>get()
;int index19 = 0;
;
for (; index19 < groupLen19;index19++){
_record = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), group19.runMethod(false,"Get",index19));Debug.locals.put("record", _record);
Debug.locals.put("record", _record);
 BA.debugLineNum = 150;BA.debugLine="If count Mod 3 = 0 Then height = height + pa";
Debug.ShouldStop(2097152);
...
main._height = RemoteObject.solve(new RemoteObject[] {main._height,_panelheight}, "+",1, 1);};
 BA.debugLineNum = 151;BA.debugLine="Dim col As Int = count Mod 3";
Debug.ShouldStop(4194304);
_col = RemoteObject.solve(new RemoteObject[] {_count,RemoteObject.createImmutable(3)}, "%",0, 1);Debug.locals.put("col", _col);Debug.locals.put("col", _col);
 BA.debugLineNum = 152;BA.debugLine="Dim row As Int = Floor(count / 3)";
Debug.ShouldStop(8388608);
_row = BA.numberCast(int.class, main.mostCurrent.__c.runMethod(true,"Floor",(Object)(RemoteObject.solve(new RemoteObject[] {_count,RemoteObject.createImmutable(3)}, "/",0, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 153;BA.debugLine="Dim name As String = record.Get(\"company_nam";
Debug.ShouldStop(16777216);
_name = BA.ObjectToString(_record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("company_name")))));Debug.locals.put("name", _name);Debug.locals.put("name", _name);
 BA.debugLineNum = 154;BA.debugLine="Dim company_id As Int = record.Get(\"company_";
Debug.ShouldStop(33554432);
_company_id = BA.numberCast(int.class, _record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("company_id")))));Debug.locals.put("company_id", _company_id);Debug.locals.put("company_id", _company_id);
 BA.debugLineNum = 155;BA.debugLine="Dim total_count As Int = record.Get(\"total_b";
Debug.ShouldStop(67108864);
_total_count = BA.numberCast(int.class, _record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("total_branch_count")))));Debug.locals.put("total_count", _total_count);Debug.locals.put("total_count", _total_count);
 BA.debugLineNum = 156;BA.debugLine="Dim total_pos As Int = record.Get(\"totalDevi";
Debug.ShouldStop(134217728);
...
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_dashpanel.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(main.mostCurrent._panel2.runMethod(true,"getHeight")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 200)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40)))));
 BA.debugLineNum = 161;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
Debug.ShouldStop(1);
...
_dashlabel.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 156)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0))));
 BA.debugLineNum = 172;BA.debugLine="dashLabel.Gravity = Gravity.CENTER_VERTICAL";
Debug.ShouldStop(2048);
_dashlabel.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"CENTER_VERTICAL"));
 BA.debugLineNum = 173;BA.debugLine="dashLabel.Typeface = Typeface.MONOSPACE";
Debug.ShouldStop(4096);
_dashlabel.runMethod(false,"setTypeface",main.mostCurrent.__c.getField(false,"Typeface").getField(false,"MONOSPACE"));
 BA.debugLineNum = 174;BA.debugLine="dashPanel.AddView(dashLabel, imgView.Width +";
Debug.ShouldStop(8192);
_dashpanel.runVoidMethod ("AddView",(Object)((_dashlabel.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_imgview.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))}, "+",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(_dashpanel.runMethod(true,"getWidth")),(Object)(_dashpanel.runMethod(true,"getHeight")));
 BA.debugLineNum = 175;BA.debugLine="calculatedSize = AdjustFontSizeToHeight(dash";
Debug.ShouldStop(16384);
main._calculatedsize = _adjustfontsizetoheight(_dashlabel,BA.numberCast(float.class, 2));
 BA.debugLineNum = 176;BA.debugLine="dashLabel.TextSize = calculatedSize";
Debug.ShouldStop(32768);
_dashlabel.runMethod(true,"setTextSize",main._calculatedsize);
 BA.debugLineNum = 178;BA.debugLine="companyPanel.Initialize(\"Panel\")";
Debug.ShouldStop(131072);
main.mostCurrent._companypanel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("Panel")));
 BA.debugLineNum = 179;BA.debugLine="ScrollView1.Panel.AddView(companyPanel, 5dip";
Debug.ShouldStop(262144);
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((main.mostCurrent._companypanel.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(_dashpanel.runMethod(true,"getHeight")),(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._activity.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 1)),(Object)(main._height));
 BA.debugLineNum = 181;BA.debugLine="mainPanelWidth = companyPanel.Width / rowNum";
Debug.ShouldStop(1048576);
...
_paneltitle.runVoidMethod ("AddView",(Object)((_label17.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(_paneltitle.runMethod(true,"getWidth")),(Object)(_paneltitle.runMethod(true,"getHeight")));
 BA.debugLineNum = 202;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
Debug.ShouldStop(512);
_myimage = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
_myimage = main.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("arrows-removebg-preview.png")));Debug.locals.put("myImage", _myimage);Debug.locals.put("myImage", _myimage);
 BA.debugLineNum = 203;BA.debugLine="If myImage.IsInitialized Then";
Debug.ShouldStop(1024);
if (_myimage.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 204;BA.debugLine="Dim resizedImage As Bitmap = myImage.Resize";
Debug.ShouldStop(2048);
...
_resizedimage = _myimage.runMethod(false,"Resize",(Object)(BA.numberCast(float.class, main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(main.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 4.5)),main.mostCurrent.activityBA))))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_myimage.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(main.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 2)),main.mostCurrent.activityBA))),_myimage.runMethod(true,"getWidth")}, "*/",0, 0))),(Object)(main.mostCurrent.__c.getField(true,"True")));Debug.locals.put("resizedImage", _resizedimage);Debug.locals.put("resizedImage", _resizedimage);
 BA.debugLineNum = 205;BA.debugLine="Dim imgView As ImageView";
Debug.ShouldStop(4096);
_imgview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("imgView", _imgview);
 BA.debugLineNum = 206;BA.debugLine="imgView.Initialize(\"\")";
Debug.ShouldStop(8192);
_imgview.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 207;BA.debugLine="imgView.Gravity = Gravity.FILL";
Debug.ShouldStop(16384);
_imgview.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 208;BA.debugLine="imgView.Bitmap = myImage";
Debug.ShouldStop(32768);
_imgview.runMethod(false,"setBitmap",(_myimage.getObject()));
 BA.debugLineNum = 209;BA.debugLine="PanelTitle.AddView(imgView, PanelTitle.Widt";
Debug.ShouldStop(65536);
_paneltitle.runVoidMethod ("AddView",(Object)((_imgview.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_paneltitle.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 5)),main.mostCurrent.activityBA)}, "-",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(main.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 5)),main.mostCurrent.activityBA)),(Object)(RemoteObject.solve(new RemoteObject[] {_paneltitle.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 1)));
 ...
 BA.debugLineNum = 211;BA.debugLine="Log(\"Error loading image\")";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5393298",RemoteObject.createImmutable("Error loading image"),0);
 };
 BA.debugLineNum = 214;BA.debugLine="Dim panelWidth As Int = Panel.Width / 3";
Debug.ShouldStop(2097152);
_panelwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_panel.runMethod(true,"getWidth"),RemoteObject.createImmutable(3)}, "/",0, 0));Debug.locals.put("panelWidth", _panelwidth);Debug.locals.put("panelWidth", _panelwidth);
 BA.debugLineNum = 215;BA.debugLine="Dim padding As Int = 10dip";
Debug.ShouldStop(4194304);
_padding = main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("padding", _padding);Debug.locals.put("padding", _padding);
 BA.debugLineNum = 216;BA.debugLine="Dim labelheight As Int = panelHeight - Panel";
Debug.ShouldStop(8388608);
_labelheight = RemoteObject.solve(new RemoteObject[] {_panelheight,_paneltitle.runMethod(true,"getHeight")}, "-",1, 1);Debug.locals.put("labelheight", _labelheight);Debug.locals.put("labelheight", _labelheight);
 BA.debugLineNum = 217;BA.debugLine="panelWidth = Panel.Width / 2";
Debug.ShouldStop(16777216);
...
_totalstorelabel.runMethod(true,"setText",BA.ObjectToCharSequence(_totalstorelabel.runMethod(true,"getText").runMethod(true,"toUpperCase")));
 BA.debugLineNum = 236;BA.debugLine="Panel.AddView(totalStoreLabel, 0, totalStore";
Debug.ShouldStop(2048);
...
_totalpos.runMethod(false,"setTypeface",main.mostCurrent.__c.getField(false,"Typeface").getField(false,"SERIF"));
 BA.debugLineNum = 245;BA.debugLine="Panel.AddView(totalPos, panelWidth, PanelTit";
Debug.ShouldStop(1048576);
_panel.runVoidMethod ("AddView",(Object)((_totalpos.getObject())),(Object)(_panelwidth),(Object)(_paneltitle.runMethod(true,"getHeight")),(Object)(_panelwidth),(Object)(RemoteObject.solve(new RemoteObject[] {_labelheight,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))}, "-",1, 1)));
 BA.debugLineNum = 247;BA.debugLine="Dim totalPosLabel As Label";
Debug.ShouldStop(4194304);
...
_totalposlabel.runMethod(true,"setText",BA.ObjectToCharSequence(_totalposlabel.runMethod(true,"getText").runMethod(true,"toUpperCase")));
 BA.debugLineNum = 255;BA.debugLine="Panel.AddView(totalPosLabel, panelWidth, tot";
Debug.ShouldStop(1073741824);
_panel.runVoidMethod ("AddView",(Object)((_totalposlabel.getObject())),(Object)(_panelwidth),(Object)(RemoteObject.solve(new RemoteObject[] {_totalpos.runMethod(true,"getTop"),_padding,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20)))}, "++",2, 1)),(Object)(_panelwidth),(Object)(_labelheight));
 BA.debugLineNum = 257;BA.debugLine="Dim cd As ColorDrawable";
Debug.ShouldStop(1);
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 258;BA.debugLine="cd.Initialize2(Colors.White, 0dip, 0dip, Col";
Debug.ShouldStop(2);
_cd.runVoidMethod ("Initialize2",(Object)(main.mostCurrent.__c.getField(false,"Colors").getField(true,"White")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent.__c.getField(false,"Colors").getField(true,"Black")));
 BA.debugLineNum = 259;BA.debugLine="Panel.Background = cd";
Debug.ShouldStop(4);
_panel.runMethod(false,"setBackground",(_cd.getObject()));
 BA.debugLineNum = 260;BA.debugLine="count = count + 1";
Debug.ShouldStop(8);
_count = RemoteObject.solve(new RemoteObject[] {_count,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("count", _count);
 }
}Debug.locals.put("record", _record);
;
 BA.debugLineNum = 262;BA.debugLine="totalGetDataHeight = Panel2.Height + companyP";
Debug.ShouldStop(32);
main._totalgetdataheight = RemoteObject.solve(new RemoteObject[] {main.mostCurrent._panel2.runMethod(true,"getHeight"),main.mostCurrent._companypanel.runMethod(true,"getHeight")}, "+",1, 1);
 break; }
case 1: {
 BA.debugLineNum = 265;BA.debugLine="Dim salesArray As List = parser.NextArray";
Debug.ShouldStop(256);
_salesarray = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_salesarray = _parser.runMethod(false,"NextArray");Debug.locals.put("salesArray", _salesarray);Debug.locals.put("salesArray", _salesarray);
 BA.debugLineNum = 266;BA.debugLine="If salesArray.Size = 0 Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",_salesarray.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 267;BA.debugLine="ToastMessageShow(\"No data received\", True)";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("No data received")),(Object)(main.mostCurrent.__c.getField(true,"True")));
...
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 271;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
Debug.ShouldStop(16384);
_totalcompanies = _salesarray.runMethod(true,"getSize");Debug.locals.put("totalCompanies", _totalcompanies);Debug.locals.put("totalCompanies", _totalcompanies);
 BA.debugLineNum = 272;BA.debugLine="Dim sales(totalCompanies) As Int";
Debug.ShouldStop(32768);
_sales = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("sales", _sales);
 BA.debugLineNum = 273;BA.debugLine="Dim comId(totalCompanies) As Int";
Debug.ShouldStop(65536);
_comid = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("comId", _comid);
 BA.debugLineNum = 274;BA.debugLine="Dim sales1(totalCompanies) As Int";
Debug.ShouldStop(131072);
_sales1 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("sales1", _sales1);
 BA.debugLineNum = 275;BA.debugLine="Dim sales2(totalCompanies) As Int";
Debug.ShouldStop(262144);
_sales2 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("sales2", _sales2);
 BA.debugLineNum = 276;BA.debugLine="Dim purchase(totalCompanies) As Int";
Debug.ShouldStop(524288);
_purchase = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase", _purchase);
 BA.debugLineNum = 277;BA.debugLine="Dim purchase1(totalCompanies) As Int";
Debug.ShouldStop(1048576);
_purchase1 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase1", _purchase1);
 BA.debugLineNum = 278;BA.debugLine="Dim purchase2(totalCompanies) As Int";
Debug.ShouldStop(2097152);
_purchase2 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase2", _purchase2);
 BA.debugLineNum = 279;BA.debugLine="Dim companyName(totalCompanies) As String";
Debug.ShouldStop(4194304);
_companyname = RemoteObject.createNewArray ("String", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("companyName", _companyname);
 BA.debugLineNum = 280;BA.debugLine="Dim max_value(totalCompanies) As Int";
Debug.ShouldStop(8388608);
_max_value = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("max_value", _max_value);
 BA.debugLineNum = 281;BA.debugLine="Dim maxSale As Int = 0";
Debug.ShouldStop(16777216);
_maxsale = BA.numberCast(int.class, 0);Debug.locals.put("maxSale", _maxsale);Debug.locals.put("maxSale", _maxsale);
 BA.debugLineNum = 283;BA.debugLine="For i = 0 To totalCompanies - 1";
Debug.ShouldStop(67108864);
{
final int step137 = 1;
final int limit137 = RemoteObject.solve(new RemoteObject[] {_totalcompanies,RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step137 > 0 && _i <= limit137) || (step137 < 0 && _i >= limit137) ;_i = ((int)(0 + _i + step137))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 284;BA.debugLine="Dim record As Map = salesArray.Get(i)";
Debug.ShouldStop(134217728);
_record = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_record = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _salesarray.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("record", _record);Debug.locals.put("record", _record);
 BA.debugLineNum = 285;BA.debugLine="companyName(i) = record.GetDefault(\"company_";
Debug.ShouldStop(268435456);
_companyname.setArrayElement (BA.ObjectToString(_record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("company_name"))),(Object)((RemoteObject.createImmutable("Unknown"))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 286;BA.debugLine="comId(i) = record.GetDefault(\"comId\", 0)";
Debug.ShouldStop(536870912);
_comid.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("comId"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 287;BA.debugLine="sales(i) = record.GetDefault(\"sales_1\", 0)";
Debug.ShouldStop(1073741824);
_sales.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("sales_1"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 288;BA.debugLine="sales1(i) = record.GetDefault(\"sales_2\", 0)";
Debug.ShouldStop(-2147483648);
_sales1.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("sales_2"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 289;BA.debugLine="sales2(i) = record.GetDefault(\"sales_3\", 0)";
Debug.ShouldStop(1);
_sales2.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("sales_3"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 290;BA.debugLine="purchase(i) = record.GetDefault(\"purchase_1\"";
Debug.ShouldStop(2);
_purchase.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_1"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 291;BA.debugLine="purchase1(i) = record.GetDefault(\"purchase_2";
Debug.ShouldStop(4);
_purchase1.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_2"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 292;BA.debugLine="purchase2(i) = record.GetDefault(\"purchase_3";
Debug.ShouldStop(8);
_purchase2.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_3"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 293;BA.debugLine="max_value(i) = record.GetDefault(\"max_sales\"";
Debug.ShouldStop(16);
_max_value.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("max_sales"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 294;BA.debugLine="maxSale = Max(maxSale, max_value(i))";
Debug.ShouldStop(32);
_maxsale = BA.numberCast(int.class, main.mostCurrent.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _maxsale)),(Object)(BA.numberCast(double.class, _max_value.getArrayElement(true,BA.numberCast(int.class, _i))))));Debug.locals.put("maxSale", _maxsale);
 BA.debugLineNum = 295;BA.debugLine="Log(companyName(i) & sales(i))";
Debug.ShouldStop(64);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5393382",RemoteObject.concat(_companyname.getArrayElement(true,BA.numberCast(int.class, _i)),_sales.getArrayElement(true,BA.numberCast(int.class, _i))),0);
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 298;BA.debugLine="If Not(barGraphInitialized) Then";
Debug.ShouldStop(512);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(main._bargraphinitialized)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 299;BA.debugLine="saleNxtBtn.Initialize(\"nxtBtn\")";
Debug.ShouldStop(1024);
main.mostCurrent._salenxtbtn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("nxtBtn")));
 BA.debugLineNum = 300;BA.debugLine="saleBackBtn.Initialize(\"backbtn\")";
Debug.ShouldStop(2048);
main.mostCurrent._salebackbtn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("backbtn")));
 BA.debugLineNum = 301;BA.debugLine="sortBtn1.Initialize(\"sortBtn1\")";
Debug.ShouldStop(4096);
main.mostCurrent._sortbtn1.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sortBtn1")));
 BA.debugLineNum = 302;BA.debugLine="sortBtn2.Initialize(\"sortBtn2\")";
Debug.ShouldStop(8192);
main.mostCurrent._sortbtn2.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sortBtn2")));
 BA.debugLineNum = 303;BA.debugLine="defBtn.Initialize(\"defBtn\")";
Debug.ShouldStop(16384);
main.mostCurrent._defbtn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("defBtn")));
 BA.debugLineNum = 304;BA.debugLine="sales1btn.Initialize(\"sales1btn\")";
Debug.ShouldStop(32768);
main.mostCurrent._sales1btn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sales1btn")));
 BA.debugLineNum = 305;BA.debugLine="sales2btn.Initialize(\"sales2btn\")";
Debug.ShouldStop(65536);
main.mostCurrent._sales2btn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sales2btn")));
 BA.debugLineNum = 306;BA.debugLine="sales3btn.Initialize(\"sales3btn\")";
Debug.ShouldStop(131072);
main.mostCurrent._sales3btn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sales3btn")));
 BA.debugLineNum = 307;BA.debugLine="showDetailButton.Initialize(\"showDetailButto";
Debug.ShouldStop(262144);
main.mostCurrent._showdetailbutton.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("showDetailButton")));
 BA.debugLineNum = 308;BA.debugLine="Dim totalSalePanel As Panel";
Debug.ShouldStop(524288);
_totalsalepanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");Debug.locals.put("totalSalePanel", _totalsalepanel);
 BA.debugLineNum = 309;BA.debugLine="totalSalePanel.Initialize(\"\")";
Debug.ShouldStop(1048576);
_totalsalepanel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 310;BA.debugLine="ScrollView1.Panel.AddView(totalSalePanel, 5d";
Debug.ShouldStop(2097152);
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_totalsalepanel.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._panel2.runMethod(true,"getHeight"),main.mostCurrent._companypanel.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 28)))}, "+-",2, 1)),(Object)(main.mostCurrent._activity.runMethod(true,"getWidth")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40)))));
 BA.debugLineNum = 312;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
Debug.ShouldStop(8388608);
_myimage = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
_myimage = main.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("stock.png")));Debug.locals.put("myImage", _myimage);Debug.locals.put("myImage", _myimage);
 BA.debugLineNum = 313;BA.debugLine="Dim imgView As ImageView";
Debug.ShouldStop(16777216);
_imgview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("imgView", _imgview);
 BA.debugLineNum = 314;BA.debugLine="imgView.Initialize(\"\")";
Debug.ShouldStop(33554432);
_imgview.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 315;BA.debugLine="imgView.Gravity = Gravity.FILL";
Debug.ShouldStop(67108864);
_imgview.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 316;BA.debugLine="imgView.Bitmap = myImage";
Debug.ShouldStop(134217728);
_imgview.runMethod(false,"setBitmap",(_myimage.getObject()));
 BA.debugLineNum = 317;BA.debugLine="totalSalePanel.AddView(imgView, 0dip, 12.5di";
Debug.ShouldStop(268435456);
_totalsalepanel.runVoidMethod ("AddView",(Object)((_imgview.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 12.5)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)))),(Object)(RemoteObject.solve(new RemoteObject[] {_totalsalepanel.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 25)))}, "-",1, 1)));
 BA.debugLineNum = 319;BA.debugLine="Dim totalSaleLabel As Label";
Debug.ShouldStop(1073741824);
...
_totalsalepanel.runVoidMethod ("AddView",(Object)((_totalsalelabel.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_imgview.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))}, "+",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent._activity.runMethod(true,"getWidth")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40)))));
 BA.debugLineNum = 326;BA.debugLine="AdjustFontSizeToHeight(totalSaleLabel, 2)";
Debug.ShouldStop(32);
_adjustfontsizetoheight(_totalsalelabel,BA.numberCast(float.class, 2));
 BA.debugLineNum = 328;BA.debugLine="ScrollView1.Panel.AddView(barPanel, 25dip, t";
Debug.ShouldStop(128);
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((main.mostCurrent._barpanel.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 25)))),(Object)(RemoteObject.solve(new RemoteObject[] {_totalsalelabel.runMethod(true,"getHeight"),main.mostCurrent._panel2.runMethod(true,"getHeight"),main.mostCurrent._companypanel.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))}, "++-",3, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._activity.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 50)))}, "-",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 450)))));
 BA.debugLineNum = 329;BA.debugLine="barPanel.Color = Colors.White";
Debug.ShouldStop(256);
main.mostCurrent._barpanel.runVoidMethod ("setColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 BA.debugLineNum = 330;BA.debugLine="barPanel.RemoveAllViews";
Debug.ShouldStop(512);
main.mostCurrent._barpanel.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 331;BA.debugLine="barPanel.Invalidate";
Debug.ShouldStop(1024);
main.mostCurrent._barpanel.runVoidMethod ("Invalidate");
 BA.debugLineNum = 333;BA.debugLine="barGraph.Initialize(Activity, barPanel, sale";
Debug.ShouldStop(4096);
main.mostCurrent._bargraph.runClassMethod (b4a.example.bargraph.class, "_initialize" /*RemoteObject*/ ,main.mostCurrent.activityBA,(Object)(main.mostCurrent._activity),(Object)(main.mostCurrent._barpanel),(Object)(_sales),(Object)(_sales1),(Object)(_sales2),(Object)(_companyname),(Object)(main.mostCurrent._legend),(Object)(_maxsale),(Object)(BA.ObjectToString("Total Sale of the Company")),(Object)(_comid),(Object)(BA.ObjectToString("Branch")),(Object)(main.mostCurrent._salenxtbtn),(Object)(main.mostCurrent._salebackbtn),(Object)(main.mostCurrent._sortbtn1),(Object)(main.mostCurrent._sortbtn2),(Object)(main.mostCurrent._defbtn),(Object)(main.mostCurrent._sales1btn),(Object)(main.mostCurrent._sales2btn),(Object)(main.mostCurrent._sales3btn));
 BA.debugLineNum = 334;BA.debugLine="barGraphInitialized = True";
Debug.ShouldStop(8192);
...
main.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
 ...
 BA.debugLineNum = 337;BA.debugLine="barGraph.sale_1 = sales";
Debug.ShouldStop(65536);
main.mostCurrent._bargraph.setField ("_sale_1" /*RemoteObject*/ ,_sales);
 BA.debugLineNum = 338;BA.debugLine="barGraph.sale_2 = sales1";
Debug.ShouldStop(131072);
main.mostCurrent._bargraph.setField ("_sale_2" /*RemoteObject*/ ,_sales1);
 BA.debugLineNum = 339;BA.debugLine="barGraph.sale_3 = sales2";
Debug.ShouldStop(262144);
main.mostCurrent._bargraph.setField ("_sale_3" /*RemoteObject*/ ,_sales2);
 BA.debugLineNum = 340;BA.debugLine="barGraph.product1 = companyName";
Debug.ShouldStop(524288);
main.mostCurrent._bargraph.setField ("_product1" /*RemoteObject*/ ,_companyname);
 BA.debugLineNum = 341;BA.debugLine="barGraph.comId1 = comId ' Corrected to use c";
Debug.ShouldStop(1048576);
main.mostCurrent._bargraph.setField ("_comid1" /*RemoteObject*/ ,_comid);
 BA.debugLineNum = 342;BA.debugLine="barGraph.UpdateGraph";
Debug.ShouldStop(2097152);
...
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 352;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
Debug.ShouldStop(-2147483648);
_totalcompanies = _salesarray.runMethod(true,"getSize");Debug.locals.put("totalCompanies", _totalcompanies);Debug.locals.put("totalCompanies", _totalcompanies);
 BA.debugLineNum = 353;BA.debugLine="Dim purchase(totalCompanies) As Int";
Debug.ShouldStop(1);
_purchase = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase", _purchase);
 BA.debugLineNum = 354;BA.debugLine="Dim purchase1(totalCompanies) As Int";
Debug.ShouldStop(2);
_purchase1 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase1", _purchase1);
 BA.debugLineNum = 355;BA.debugLine="Dim purchase2(totalCompanies) As Int";
Debug.ShouldStop(4);
_purchase2 = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("purchase2", _purchase2);
 BA.debugLineNum = 356;BA.debugLine="Dim companyName(totalCompanies) As String";
Debug.ShouldStop(8);
_companyname = RemoteObject.createNewArray ("String", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("companyName", _companyname);
 BA.debugLineNum = 357;BA.debugLine="Dim comId(totalCompanies) As Int";
Debug.ShouldStop(16);
_comid = RemoteObject.createNewArray ("int", new int[] {_totalcompanies.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("comId", _comid);
 BA.debugLineNum = 358;BA.debugLine="Dim maxSale As Int = 0";
Debug.ShouldStop(32);
_maxsale = BA.numberCast(int.class, 0);Debug.locals.put("maxSale", _maxsale);Debug.locals.put("maxSale", _maxsale);
 BA.debugLineNum = 360;BA.debugLine="For i = 0 To totalCompanies - 1";
Debug.ShouldStop(128);
{
final int step206 = 1;
final int limit206 = RemoteObject.solve(new RemoteObject[] {_totalcompanies,RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step206 > 0 && _i <= limit206) || (step206 < 0 && _i >= limit206) ;_i = ((int)(0 + _i + step206))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 361;BA.debugLine="Dim record As Map = salesArray.Get(i)";
Debug.ShouldStop(256);
_record = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_record = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _salesarray.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("record", _record);Debug.locals.put("record", _record);
 BA.debugLineNum = 362;BA.debugLine="companyName(i) = record.GetDefault(\"company_";
Debug.ShouldStop(512);
_companyname.setArrayElement (BA.ObjectToString(_record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("company_name"))),(Object)((RemoteObject.createImmutable("Unknown"))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 363;BA.debugLine="comId(i) = record.GetDefault(\"comId\", 0)";
Debug.ShouldStop(1024);
_comid.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("comId"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 364;BA.debugLine="purchase(i) = record.GetDefault(\"purchase_1\"";
Debug.ShouldStop(2048);
_purchase.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_1"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 365;BA.debugLine="purchase1(i) = record.GetDefault(\"purchase_2";
Debug.ShouldStop(4096);
_purchase1.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_2"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 366;BA.debugLine="purchase2(i) = record.GetDefault(\"purchase_3";
Debug.ShouldStop(8192);
_purchase2.setArrayElement (BA.numberCast(int.class, _record.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("purchase_3"))),(Object)(RemoteObject.createImmutable((0))))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 367;BA.debugLine="maxSale = Max(maxSale, record.GetDefault(\"ma";
Debug.ShouldStop(16384);
...
;
 BA.debugLineNum = 370;BA.debugLine="If Not(barGraphInitializedPurchase) Then";
Debug.ShouldStop(131072);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(main._bargraphinitializedpurchase)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 371;BA.debugLine="purchNxtBtn.Initialize(\"purchNxtBtn\")";
Debug.ShouldStop(262144);
main.mostCurrent._purchnxtbtn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("purchNxtBtn")));
 BA.debugLineNum = 372;BA.debugLine="purchBackBtn.Initialize(\"purchBackBtn\")";
Debug.ShouldStop(524288);
main.mostCurrent._purchbackbtn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("purchBackBtn")));
 BA.debugLineNum = 373;BA.debugLine="sortBtnPurchase1.Initialize(\"sortBtnPurchase";
Debug.ShouldStop(1048576);
main.mostCurrent._sortbtnpurchase1.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sortBtnPurchase1")));
 BA.debugLineNum = 374;BA.debugLine="sortBtnPurchase2.Initialize(\"sortBtnPurchase";
Debug.ShouldStop(2097152);
main.mostCurrent._sortbtnpurchase2.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sortBtnPurchase2")));
 BA.debugLineNum = 375;BA.debugLine="defBtnPurchase.Initialize(\"defBtnPurchase\")";
Debug.ShouldStop(4194304);
main.mostCurrent._defbtnpurchase.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("defBtnPurchase")));
 BA.debugLineNum = 376;BA.debugLine="purch1btn.Initialize(\"purch1btn\")";
Debug.ShouldStop(8388608);
main.mostCurrent._purch1btn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("purch1btn")));
 BA.debugLineNum = 377;BA.debugLine="purch2btn.Initialize(\"purch2btn\")";
Debug.ShouldStop(16777216);
main.mostCurrent._purch2btn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("purch2btn")));
 BA.debugLineNum = 378;BA.debugLine="purch3btn.Initialize(\"purch3btn\")";
Debug.ShouldStop(33554432);
main.mostCurrent._purch3btn.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("purch3btn")));
 BA.debugLineNum = 379;BA.debugLine="showDetailButton.Initialize(\"showDetailButto";
Debug.ShouldStop(67108864);
main.mostCurrent._showdetailbutton.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("showDetailButton")));
 BA.debugLineNum = 381;BA.debugLine="Dim totalPurchasePanel As Panel";
Debug.ShouldStop(268435456);
_totalpurchasepanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");Debug.locals.put("totalPurchasePanel", _totalpurchasepanel);
 BA.debugLineNum = 382;BA.debugLine="totalPurchasePanel.Initialize(\"\")";
Debug.ShouldStop(536870912);
_totalpurchasepanel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 383;BA.debugLine="ScrollView1.Panel.AddView(totalPurchasePanel";
Debug.ShouldStop(1073741824);
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_totalpurchasepanel.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))),(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._barpanel.runMethod(true,"getTop"),main.mostCurrent._barpanel.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)))}, "++",2, 1)),(Object)(main.mostCurrent._activity.runMethod(true,"getWidth")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40)))));
 BA.debugLineNum = 385;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
Debug.ShouldStop(1);
_myimage = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
_myimage = main.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("stock.png")));Debug.locals.put("myImage", _myimage);Debug.locals.put("myImage", _myimage);
 BA.debugLineNum = 386;BA.debugLine="Dim imgView As ImageView";
Debug.ShouldStop(2);
_imgview = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("imgView", _imgview);
 BA.debugLineNum = 387;BA.debugLine="imgView.Initialize(\"\")";
Debug.ShouldStop(4);
_imgview.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 388;BA.debugLine="imgView.Gravity = Gravity.FILL";
Debug.ShouldStop(8);
_imgview.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 389;BA.debugLine="imgView.Bitmap = myImage";
Debug.ShouldStop(16);
_imgview.runMethod(false,"setBitmap",(_myimage.getObject()));
 BA.debugLineNum = 390;BA.debugLine="totalPurchasePanel.AddView(imgView, 0dip, 12";
Debug.ShouldStop(32);
_totalpurchasepanel.runVoidMethod ("AddView",(Object)((_imgview.getObject())),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 12.5)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)))),(Object)(RemoteObject.solve(new RemoteObject[] {_totalpurchasepanel.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 25)))}, "-",1, 1)));
 BA.debugLineNum = 392;BA.debugLine="Dim totalPurchaseLabel As Label";
Debug.ShouldStop(128);
...
main.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
 ...
 BA.debugLineNum = 410;BA.debugLine="barGraphPurchase.sale_1 = purchase ' Adjuste";
Debug.ShouldStop(33554432);
main.mostCurrent._bargraphpurchase.setField ("_sale_1" /*RemoteObject*/ ,_purchase);
 BA.debugLineNum = 411;BA.debugLine="barGraphPurchase.sale_2 = purchase1";
Debug.ShouldStop(67108864);
main.mostCurrent._bargraphpurchase.setField ("_sale_2" /*RemoteObject*/ ,_purchase1);
 BA.debugLineNum = 412;BA.debugLine="barGraphPurchase.sale_3 = purchase2";
Debug.ShouldStop(134217728);
main.mostCurrent._bargraphpurchase.setField ("_sale_3" /*RemoteObject*/ ,_purchase2);
 BA.debugLineNum = 413;BA.debugLine="barGraphPurchase.product1 = companyName";
Debug.ShouldStop(268435456);
main.mostCurrent._bargraphpurchase.setField ("_product1" /*RemoteObject*/ ,_companyname);
 BA.debugLineNum = 414;BA.debugLine="barGraphPurchase.comId1 = comId ' Corrected";
Debug.ShouldStop(536870912);
main.mostCurrent._bargraphpurchase.setField ("_comid1" /*RemoteObject*/ ,_comid);
 BA.debugLineNum = 415;BA.debugLine="barGraphPurchase.UpdateGraph";
Debug.ShouldStop(1073741824);
main.mostCurrent._bargraphpurchase.runClassMethod (b4a.example.bargraph.class, "_updategraph" /*RemoteObject*/ );
 };
 BA.debugLineNum = 418;BA.debugLine="ScrollView1.Panel.Height = purchasePanel.Top";
Debug.ShouldStop(2);
main.mostCurrent._scrollview1.runMethod(false,"getPanel").runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {main.mostCurrent._purchasepanel.runMethod(true,"getTop"),main.mostCurrent._purchasepanel.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 300)))}, "++",2, 1));
 BA.debugLineNum = 419;BA.debugLine="Log($\"maxSale:${maxSale}\"$)";
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5393506",(RemoteObject.concat(RemoteObject.createImmutable("maxSale:"),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_maxsale))),RemoteObject.createImmutable(""))),0);
 break; }
case 3: {
 BA.debugLineNum = 422;BA.debugLine="ToastMessageShow(\"Data updated successfully\",";
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Data updated successfully")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 423;BA.debugLine="LoadCompanyData";
Debug.ShouldStop(64);
_loadcompanydata();
 break; }
default: {
 BA.debugLineNum = 425;BA.debugLine="Log(\"Unknown job: \" & job.JobName)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5393512",RemoteObject.concat(RemoteObject.createImmutable("Unknown job: "),_job.getField(true,"_jobname" /*RemoteObject*/ )),0);
 break; }
}
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e266.toString()); BA.debugLineNum = 429;BA.debugLine="Log(\"Error parsing data: \" & LastException.Mess";
Debug.ShouldStop(4096);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5393516",RemoteObject.concat(RemoteObject.createImmutable("Error parsing data: "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 };
 }else {
 BA.debugLineNum = 432;BA.debugLine="ToastMessageShow(\"Error: \" & job.ErrorMessage, T";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("Label17_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,443);
...
RemoteObject _selectedcompany = RemoteObject.createImmutable("");
 BA.debugLineNum = 443;BA.debugLine="Private Sub Label17_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 444;BA.debugLine="Dim clickedLabel As Label = Sender";
Debug.ShouldStop(134217728);
...
_clickedlabel = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("clickedLabel", _clickedlabel);Debug.locals.put("clickedLabel", _clickedlabel);
 BA.debugLineNum = 445;BA.debugLine="Dim selectedCompany As String = clickedLabel.Tag";
Debug.ShouldStop(268435456);
_selectedcompany = BA.ObjectToString(_clickedlabel.runMethod(false,"getTag"));Debug.locals.put("selectedCompany", _selectedcompany);Debug.locals.put("selectedCompany", _selectedcompany);
 BA.debugLineNum = 446;BA.debugLine="Starter.company_selected = selectedCompany";
Debug.ShouldStop(536870912);
main.mostCurrent._starter._company_selected /*RemoteObject*/  = _selectedcompany;
 BA.debugLineNum = 447;BA.debugLine="StartActivity(\"Branch\")";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("LoadCompanyData (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,92);
...
RemoteObject _job1 = RemoteObject.declareNull("b4a.example.httpjob");
 BA.debugLineNum = 92;BA.debugLine="Sub LoadCompanyData";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 93;BA.debugLine="Try";
Debug.ShouldStop(268435456);
try { BA.debugLineNum = 94;BA.debugLine="Dim Job1 As HttpJob";
Debug.ShouldStop(536870912);
_job1 = RemoteObject.createNew ("b4a.example.httpjob");Debug.locals.put("Job1", _job1);
 BA.debugLineNum = 95;BA.debugLine="Job1.Initialize(\"GetData\", Me)";
Debug.ShouldStop(1073741824);
_job1.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,main.processBA,(Object)(BA.ObjectToString("GetData")),(Object)(main.getObject()));
 BA.debugLineNum = 96;BA.debugLine="Job1.Download(PHPURL)";
Debug.ShouldStop(-2147483648);
_job1.runClassMethod (b4a.example.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(main.mostCurrent._phpurl));
 BA.debugLineNum = 97;BA.debugLine="ProgressDialogShow(\"Loading Data...\")";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",main.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Loading Data..."))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e7.toString()); BA.debugLineNum = 99;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("LoadGraphData (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,103);
if (RapidSub.canDelegate("loadgraphdata")) { return b4a.example.main.remoteMe.runUserSub(false, "main","loadgraphdata");}
RemoteObject _job1 = RemoteObject.declareNull("b4a.example.httpjob");
 BA.debugLineNum = 103;BA.debugLine="Sub LoadGraphData";
Debug.ShouldStop(64);
 BA.debugLineNum = 104;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 105;BA.debugLine="PHPURLCompany = $\"https://192.168.8.117/Company/";
Debug.ShouldStop(256);
main.mostCurrent._phpurlcompany = (RemoteObject.concat(RemoteObject.createImmutable("https://192.168.8.117/Company/controller/company.php?action=get_company_list&page="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._currentpage))),RemoteObject.createImmutable("&company_sales="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._salesdata1))),RemoteObject.createImmutable("&sort_type="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable("")));
 BA.debugLineNum = 106;BA.debugLine="Dim Job1 As HttpJob";
Debug.ShouldStop(512);
_job1 = RemoteObject.createNew ("b4a.example.httpjob");Debug.locals.put("Job1", _job1);
 BA.debugLineNum = 107;BA.debugLine="Job1.Initialize(\"GetCompany\", Me)";
Debug.ShouldStop(1024);
_job1.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,main.processBA,(Object)(BA.ObjectToString("GetCompany")),(Object)(main.getObject()));
 BA.debugLineNum = 108;BA.debugLine="Job1.Download(PHPURLCompany)";
Debug.ShouldStop(2048);
_job1.runClassMethod (b4a.example.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(main.mostCurrent._phpurlcompany));
 BA.debugLineNum = 109;BA.debugLine="ProgressDialogShow(\"Loading Graph Data...\")";
Debug.ShouldStop(4096);
main.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",main.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Loading Graph Data..."))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e8.toString()); BA.debugLineNum = 111;BA.debugLine="Log(\"LoadGraphData Error: \" & LastException.Mess";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5262152",RemoteObject.concat(RemoteObject.createImmutable("LoadGraphData Error: "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 BA.debugLineNum = 112;BA.debugLine="ToastMessageShow(\"Error initiating graph load: \"";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("LoadGraphDataPurchase (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,116);
...
RemoteObject _job1 = RemoteObject.declareNull("b4a.example.httpjob");
 BA.debugLineNum = 116;BA.debugLine="Sub LoadGraphDataPurchase";
Debug.ShouldStop(524288);
 BA.debugLineNum = 117;BA.debugLine="Try";
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 118;BA.debugLine="PHPURLCompany = $\"https://192.168.8.117/Company/";
Debug.ShouldStop(2097152);
main.mostCurrent._phpurlcompany = (RemoteObject.concat(RemoteObject.createImmutable("https://192.168.8.117/Company/controller/company.php?action=get_company_list&page="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._currentpage))),RemoteObject.createImmutable("&company_purchase="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._salesdata1))),RemoteObject.createImmutable("&sort_type="),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable("")));
 BA.debugLineNum = 119;BA.debugLine="Dim Job1 As HttpJob";
Debug.ShouldStop(4194304);
_job1 = RemoteObject.createNew ("b4a.example.httpjob");Debug.locals.put("Job1", _job1);
 BA.debugLineNum = 120;BA.debugLine="Job1.Initialize(\"GetCompanyPurchase\", Me)";
Debug.ShouldStop(8388608);
_job1.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,main.processBA,(Object)(BA.ObjectToString("GetCompanyPurchase")),(Object)(main.getObject()));
 BA.debugLineNum = 121;BA.debugLine="Job1.Download(PHPURLCompany)";
Debug.ShouldStop(16777216);
_job1.runClassMethod (b4a.example.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(main.mostCurrent._phpurlcompany));
 BA.debugLineNum = 122;BA.debugLine="ProgressDialogShow(\"Loading Graph Data...\")";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",main.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Loading Graph Data..."))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e8) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e8.toString()); BA.debugLineNum = 124;BA.debugLine="Log(\"LoadGraphData Error: \" & LastException.Mess";
Debug.ShouldStop(134217728);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5327688",RemoteObject.concat(RemoteObject.createImmutable("LoadGraphData Error: "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 BA.debugLineNum = 125;BA.debugLine="ToastMessageShow(\"Error initiating graph load: \"";
Debug.ShouldStop(268435456);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Error initiating graph load: "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")))),(Object)(main.mostCurrent.__c.getField(true,"True")));
 };
...
try {
		Debug.PushSubsStack("nxtBtn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,450);
if (RapidSub.canDelegate("nxtbtn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","nxtbtn_click");}
 BA.debugLineNum = 450;BA.debugLine="Sub nxtBtn_Click";
Debug.ShouldStop(2);
 BA.debugLineNum = 451;BA.debugLine="Log(\"sad\")";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("purch1btn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,641);
if (RapidSub.canDelegate("purch1btn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","purch1btn_click");}
 BA.debugLineNum = 641;BA.debugLine="Sub purch1btn_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 642;BA.debugLine="salesData1 = 1";
Debug.ShouldStop(2);
main._salesdata1 = BA.numberCast(int.class, 1);
 BA.debugLineNum = 643;BA.debugLine="Log(\"Purchase 1 selected\")";
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51310722",RemoteObject.createImmutable("Purchase 1 selected"),0);
 BA.debugLineNum = 644;BA.debugLine="If sortDefaultValue <> \"\" Then";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("purch2btn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,649);
if (RapidSub.canDelegate("purch2btn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","purch2btn_click");}
 BA.debugLineNum = 649;BA.debugLine="Sub purch2btn_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 650;BA.debugLine="salesData1 = 2";
Debug.ShouldStop(512);
main._salesdata1 = BA.numberCast(int.class, 2);
 BA.debugLineNum = 651;BA.debugLine="Log(\"Purchase 2 selected\")";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51376258",RemoteObject.createImmutable("Purchase 2 selected"),0);
 BA.debugLineNum = 652;BA.debugLine="If sortDefaultValue <> \"\" Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("!",main.mostCurrent._sortdefaultvalue,BA.ObjectToString(""))) { 
 };
...
try {
		Debug.PushSubsStack("purch3btn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,657);
if (RapidSub.canDelegate("purch3btn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","purch3btn_click");}
 BA.debugLineNum = 657;BA.debugLine="Sub purch3btn_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 658;BA.debugLine="salesData1 = 3";
Debug.ShouldStop(131072);
main._salesdata1 = BA.numberCast(int.class, 3);
 BA.debugLineNum = 659;BA.debugLine="Log(\"Purchase 3 selected\")";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51441794",RemoteObject.createImmutable("Purchase 3 selected"),0);
 BA.debugLineNum = 660;BA.debugLine="If sortDefaultValue <> \"\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("!",main.mostCurrent._sortdefaultvalue,BA.ObjectToString(""))) { 
 };
...
try {
		Debug.PushSubsStack("sales1btn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,543);
if (RapidSub.canDelegate("sales1btn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","sales1btn_click");}
 BA.debugLineNum = 543;BA.debugLine="Sub sales1btn_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 544;BA.debugLine="salesData1 = 1";
Debug.ShouldStop(-2147483648);
main._salesdata1 = BA.numberCast(int.class, 1);
 BA.debugLineNum = 545;BA.debugLine="Log(\"Sales 1 selected\")";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5983042",RemoteObject.createImmutable("Sales 1 selected"),0);
 BA.debugLineNum = 546;BA.debugLine="If sortDefaultValue <> \"\" Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("!",main.mostCurrent._sortdefaultvalue,BA.ObjectToString(""))) { 
 };
...
try {
		Debug.PushSubsStack("sales2btn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,551);
if (RapidSub.canDelegate("sales2btn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","sales2btn_click");}
 BA.debugLineNum = 551;BA.debugLine="Sub sales2btn_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 552;BA.debugLine="salesData1 = 2";
Debug.ShouldStop(128);
main._salesdata1 = BA.numberCast(int.class, 2);
 BA.debugLineNum = 553;BA.debugLine="Log(\"Sales 2 selected\")";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51048578",RemoteObject.createImmutable("Sales 2 selected"),0);
 BA.debugLineNum = 554;BA.debugLine="If sortDefaultValue <> \"\" Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("!",main.mostCurrent._sortdefaultvalue,BA.ObjectToString(""))) { 
 };
...
try {
		Debug.PushSubsStack("sales3btn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,559);
if (RapidSub.canDelegate("sales3btn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","sales3btn_click");}
 BA.debugLineNum = 559;BA.debugLine="Sub sales3btn_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 560;BA.debugLine="salesData1 = 3";
Debug.ShouldStop(32768);
main._salesdata1 = BA.numberCast(int.class, 3);
 BA.debugLineNum = 561;BA.debugLine="Log(\"Sales 3 selected\")";
Debug.ShouldStop(65536);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51114114",RemoteObject.createImmutable("Sales 3 selected"),0);
 BA.debugLineNum = 562;BA.debugLine="If sortDefaultValue <> \"\" Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("!",main.mostCurrent._sortdefaultvalue,BA.ObjectToString(""))) { 
 };
...
try {
		Debug.PushSubsStack("sortBtn1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,454);
...
RemoteObject _checkedsales = null;
 BA.debugLineNum = 454;BA.debugLine="Sub sortBtn1_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 455;BA.debugLine="Dim chk As RadioButton = Sender";
Debug.ShouldStop(64);
...
_chk = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("chk", _chk);Debug.locals.put("chk", _chk);
 BA.debugLineNum = 456;BA.debugLine="Dim index As String = chk.Tag";
Debug.ShouldStop(128);
_index = BA.ObjectToString(_chk.runMethod(false,"getTag"));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 458;BA.debugLine="sortDefaultValue = index.ToLowerCase ' \"asc\"";
Debug.ShouldStop(512);
main.mostCurrent._sortdefaultvalue = _index.runMethod(true,"toLowerCase");
 BA.debugLineNum = 459;BA.debugLine="Log($\"sort value: ${sortDefaultValue}\"$)";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5720901",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 461;BA.debugLine="If Not(barGraphInitialized) Then";
Debug.ShouldStop(4096);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(main._bargraphinitialized)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 462;BA.debugLine="ToastMessageShow(\"Graph not yet initialized.\", T";
Debug.ShouldStop(8192);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 467;BA.debugLine="Dim checkedSales() As Boolean = barGraph.GetCheck";
Debug.ShouldStop(262144);
_checkedsales = main.mostCurrent._bargraph.runClassMethod (b4a.example.bargraph.class, "_getcheckedsales" /*RemoteObject*/ );Debug.locals.put("checkedSales", _checkedsales);Debug.locals.put("checkedSales", _checkedsales);
 BA.debugLineNum = 468;BA.debugLine="If checkedSales.Length > 0 Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean(">",_checkedsales.getField(true,"length"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 469;BA.debugLine="Select Case salesData1";
Debug.ShouldStop(1048576);
...
case 0: {
 BA.debugLineNum = 471;BA.debugLine="If Not(checkedSales(0)) Then";
Debug.ShouldStop(4194304);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 0)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 472;BA.debugLine="ToastMessageShow(\"Please show Sales1 in the l";
Debug.ShouldStop(8388608);
...
if (true) return RemoteObject.createImmutable("");
 ...
 break; }
case 1: {
 BA.debugLineNum = 476;BA.debugLine="If Not(checkedSales(1)) Then";
Debug.ShouldStop(134217728);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 1)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 477;BA.debugLine="ToastMessageShow(\"Please show Sales2 in the l";
Debug.ShouldStop(268435456);
...
if (true) return RemoteObject.createImmutable("");
 ...
 break; }
case 2: {
 BA.debugLineNum = 481;BA.debugLine="If Not(checkedSales(2)) Then";
Debug.ShouldStop(1);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 2)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 482;BA.debugLine="ToastMessageShow(\"Please show Sales3 in the l";
Debug.ShouldStop(2);
...
;
 ...
 BA.debugLineNum = 488;BA.debugLine="LoadGraphData";
Debug.ShouldStop(128);
_loadgraphdata();
...
Debug.ShouldStop(65536);
main.mostCurrent.__c.runVoidMethod ("LogImpl","5786437",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("sortBtnPurchase1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,567);
...
RemoteObject _index = RemoteObject.createImmutable("");
RemoteObject _checkedsales = null;
 BA.debugLineNum = 567;BA.debugLine="Sub sortBtnPurchase1_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 568;BA.debugLine="Dim chk As RadioButton = Sender";
Debug.ShouldStop(8388608);
_chk = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
_chk = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("chk", _chk);Debug.locals.put("chk", _chk);
 BA.debugLineNum = 569;BA.debugLine="Dim index As String = chk.Tag";
Debug.ShouldStop(16777216);
_index = BA.ObjectToString(_chk.runMethod(false,"getTag"));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 571;BA.debugLine="sortDefaultValue = index.ToLowerCase ' \"desc\"";
Debug.ShouldStop(67108864);
main.mostCurrent._sortdefaultvalue = _index.runMethod(true,"toLowerCase");
 BA.debugLineNum = 572;BA.debugLine="Log($\"sort value: ${sortDefaultValue}\"$)";
Debug.ShouldStop(134217728);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51179653",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 574;BA.debugLine="If Not(barGraphInitializedPurchase) Then";
Debug.ShouldStop(536870912);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(main._bargraphinitializedpurchase)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 575;BA.debugLine="ToastMessageShow(\"Graph not yet initialized.\", T";
Debug.ShouldStop(1073741824);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Graph not yet initialized.")),(Object)(main.mostCurrent.__c.getField(true,"True")));
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 580;BA.debugLine="Dim checkedSales() As Boolean = barGraphPurchase.";
Debug.ShouldStop(8);
_checkedsales = main.mostCurrent._bargraphpurchase.runClassMethod (b4a.example.bargraph.class, "_getcheckedsales" /*RemoteObject*/ );Debug.locals.put("checkedSales", _checkedsales);Debug.locals.put("checkedSales", _checkedsales);
 BA.debugLineNum = 581;BA.debugLine="If checkedSales.Length > 0 Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean(">",_checkedsales.getField(true,"length"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 582;BA.debugLine="Select Case salesData1";
Debug.ShouldStop(32);
switch (BA.switchObjectToInt(main._salesdata1,BA.numberCast(int.class, 1),BA.numberCast(int.class, 2),BA.numberCast(int.class, 3))) {
case 0: {
 BA.debugLineNum = 584;BA.debugLine="If Not(checkedSales(0)) Then";
Debug.ShouldStop(128);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 0)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 585;BA.debugLine="ToastMessageShow(\"Please show Purchase 1 in t";
Debug.ShouldStop(256);
...
if (true) return RemoteObject.createImmutable("");
 ...
 break; }
case 1: {
 BA.debugLineNum = 589;BA.debugLine="If Not(checkedSales(1)) Then";
Debug.ShouldStop(4096);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 1)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 590;BA.debugLine="ToastMessageShow(\"Please show Purchase 2 in t";
Debug.ShouldStop(8192);
...
if (true) return RemoteObject.createImmutable("");
 ...
 break; }
case 2: {
 BA.debugLineNum = 594;BA.debugLine="If Not(checkedSales(2)) Then";
Debug.ShouldStop(131072);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 2)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 595;BA.debugLine="ToastMessageShow(\"Please show Purchase 3 in t";
Debug.ShouldStop(262144);
...
;
 ...
 BA.debugLineNum = 601;BA.debugLine="LoadGraphDataPurchase";
Debug.ShouldStop(16777216);
_loadgraphdatapurchase();
...
try {
		Debug.PushSubsStack("sortBtnPurchase2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,604);
...
RemoteObject _index = RemoteObject.createImmutable("");
RemoteObject _checkedsales = null;
 BA.debugLineNum = 604;BA.debugLine="Sub sortBtnPurchase2_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 605;BA.debugLine="Dim chk As RadioButton = Sender";
Debug.ShouldStop(268435456);
_chk = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper");
_chk = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("chk", _chk);Debug.locals.put("chk", _chk);
 BA.debugLineNum = 606;BA.debugLine="Dim index As String = chk.Tag";
Debug.ShouldStop(536870912);
_index = BA.ObjectToString(_chk.runMethod(false,"getTag"));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 608;BA.debugLine="sortDefaultValue = index.ToLowerCase ' \"desc\"";
Debug.ShouldStop(-2147483648);
main.mostCurrent._sortdefaultvalue = _index.runMethod(true,"toLowerCase");
 BA.debugLineNum = 609;BA.debugLine="Log($\"sort value: ${sortDefaultValue}\"$)";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("LogImpl","51245189",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 611;BA.debugLine="If Not(barGraphInitializedPurchase) Then";
Debug.ShouldStop(4);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(main._bargraphinitializedpurchase)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 612;BA.debugLine="ToastMessageShow(\"Graph not yet initialized.\", T";
Debug.ShouldStop(8);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Graph not yet initialized.")),(Object)(main.mostCurrent.__c.getField(true,"True")));
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 617;BA.debugLine="Dim checkedSales() As Boolean = barGraphPurchase.";
Debug.ShouldStop(256);
_checkedsales = main.mostCurrent._bargraphpurchase.runClassMethod (b4a.example.bargraph.class, "_getcheckedsales" /*RemoteObject*/ );Debug.locals.put("checkedSales", _checkedsales);Debug.locals.put("checkedSales", _checkedsales);
 BA.debugLineNum = 618;BA.debugLine="If checkedSales.Length > 0 Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean(">",_checkedsales.getField(true,"length"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 619;BA.debugLine="Select Case salesData1";
Debug.ShouldStop(1024);
switch (BA.switchObjectToInt(main._salesdata1,BA.numberCast(int.class, 1),BA.numberCast(int.class, 2),BA.numberCast(int.class, 3))) {
case 0: {
 BA.debugLineNum = 621;BA.debugLine="If Not(checkedSales(0)) Then";
Debug.ShouldStop(4096);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 0)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 622;BA.debugLine="ToastMessageShow(\"Please show Purchase 1 in t";
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Please show Purchase 1 in the legend before sorting by it.")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 623;BA.debugLine="Return";
Debug.ShouldStop(16384);
if (true) return RemoteObject.createImmutable("");
 };
 break; }
case 1: {
 BA.debugLineNum = 626;BA.debugLine="If Not(checkedSales(1)) Then";
Debug.ShouldStop(131072);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 1)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 627;BA.debugLine="ToastMessageShow(\"Please show Purchase 2 in t";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Please show Purchase 2 in the legend before sorting by it.")),(Object)(main.mostCurrent.__c.getField(true,"True")));
...
if (true) return RemoteObject.createImmutable("");
 ...
 break; }
case 2: {
 BA.debugLineNum = 631;BA.debugLine="If Not(checkedSales(2)) Then";
Debug.ShouldStop(4194304);
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(_checkedsales.getArrayElement(true,BA.numberCast(int.class, 2)))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 632;BA.debugLine="ToastMessageShow(\"Please show Purchase 3 in t";
Debug.ShouldStop(8388608);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Please show Purchase 3 in the legend before sorting by it.")),(Object)(main.mostCurrent.__c.getField(true,"True")));
...
;
 ...
 BA.debugLineNum = 638;BA.debugLine="LoadGraphDataPurchase";
Debug.ShouldStop(536870912);
_loadgraphdatapurchase();
