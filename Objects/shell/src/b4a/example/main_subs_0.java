...
Debug.ShouldStop(1048576);
main.mostCurrent.__c.runVoidMethod ("LogImpl","7851970",RemoteObject.createImmutable("Default sorting applied"),0);
...
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("LogImpl","7327776",RemoteObject.createImmutable("Error loading image"),0);
 };
...
Debug.ShouldStop(4096);
main.mostCurrent.__c.runVoidMethod ("LogImpl","7327866",RemoteObject.concat(_companyname.getArrayElement(true,BA.numberCast(int.class, _i)),_sales.getArrayElement(true,BA.numberCast(int.class, _i))),0);
 }
}Debug.locals.put("i", _i);
;
...
_totalsalepanel.runVoidMethod ("AddView",(Object)((_totalsalelabel.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_imgview.runMethod(true,"getWidth"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))}, "+",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))),(Object)(main.mostCurrent._activity.runMethod(true,"getWidth")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40)))));
 BA.debugLineNum = 338;BA.debugLine="AdjustFontSizeToHeight(totalSaleLabel,2)";
Debug.ShouldStop(131072);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e246.toString()); BA.debugLineNum = 415;BA.debugLine="Log(\"\")";
Debug.ShouldStop(1073741824);
...
Debug.ShouldStop(65536);
main.mostCurrent.__c.runVoidMethod ("LogImpl","7786437",(RemoteObject.concat(RemoteObject.createImmutable("sort value: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.mostCurrent._sortdefaultvalue))),RemoteObject.createImmutable(""))),0);
