...
anywheresoftware.b4a.keywords.Common.LogImpl("71507335",mostCurrent._starter._company_selected /*String*/ +"id",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71441799",mostCurrent._starter._company_selected /*String*/ +"isd",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71441803",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("72490373",_index,0);
RDebugUtils.currentLine=2490374;
 //BA.debugLineNum = 2490374;BA.debugLine="Log(\"(default)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("72490374","(default)",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71769480","Invalid input values",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638480","Error loading image",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638671","No branch data returned",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638711","Bar graph initialized",0);
 }else {
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638720","Bar graph updated",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638732","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638736","Error parsing data: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71638740","Job failed: "+_job._errormessage /*String*/ ,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72359298",BA.NumberToString(_currentpage),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72686983",mostCurrent._sortdefaultvalue,0);
RDebugUtils.currentLine=2686984;
 //BA.debugLineNum = 2686984;BA.debugLine="Log(\" sales 1 Button clicked: \" & index)";
anywheresoftware.b4a.keywords.Common.LogImpl("72686984"," sales 1 Button clicked: "+_index,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72752519",mostCurrent._sortdefaultvalue,0);
RDebugUtils.currentLine=2752520;
 //BA.debugLineNum = 2752520;BA.debugLine="Log(index)";
anywheresoftware.b4a.keywords.Common.LogImpl("72752520",_index,0);
RDebugUtils.currentLine=2752521;
 //BA.debugLineNum = 2752521;BA.debugLine="Log(\"(Sale2)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("72752521","(Sale2)",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72818055",mostCurrent._sortdefaultvalue,0);
RDebugUtils.currentLine=2818057;
 //BA.debugLineNum = 2818057;BA.debugLine="Log(index)";
anywheresoftware.b4a.keywords.Common.LogImpl("72818057",_index,0);
RDebugUtils.currentLine=2818058;
 //BA.debugLineNum = 2818058;BA.debugLine="Log(\"(Sale3)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("72818058","(Sale3)",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72621445",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72555909",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
