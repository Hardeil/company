...
RDebugUtils.currentLine=262187;
 //BA.debugLineNum = 262187;BA.debugLine="ScrollView1.Panel.AddView(Panel, leftPositio";
...
{
final int step93 = 1;
final int limit93 = (int) (_salesarray.getSize()-1);
_i = (int) (0) ;
...
;
RDebugUtils.currentLine=262301;
 //BA.debugLineNum = 262301;BA.debugLine="Dim legend() As String = Array As String(";
mostCurrent._legend = new String[]{"Sales1","Sales2","Sales3"};
 }else {
RDebugUtils.currentLine=262304;
 //BA.debugLineNum = 262304;BA.debugLine="Log($\"Company: ${name} has no branches inform";
anywheresoftware.b4a.keywords.Common.LogImpl("8262304",("Company: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_name))+" has no branches information."),0);
 };
 };
 }
};
RDebugUtils.currentLine=262313;
 //BA.debugLineNum = 262313;BA.debugLine="If Activity.Width >= 1340 Then";
if (mostCurrent._activity.getWidth()>=1340) { 
RDebugUtils.currentLine=262314;
 //BA.debugLineNum = 262314;BA.debugLine="count = count + 1";
_count = (int) (_count+1);
RDebugUtils.currentLine=262315;
 //BA.debugLineNum = 262315;BA.debugLine="If count Mod numColumns = 0 Then";
if (_count%_numcolumns==0) { 
RDebugUtils.currentLine=262317;
 //BA.debugLineNum = 262317;BA.debugLine="leftPosition = 10dip";
_leftposition = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
RDebugUtils.currentLine=262318;
 //BA.debugLineNum = 262318;BA.debugLine="topPosition = topPosition + pnlHeight + pa";
_topposition = (int) (_topposition+_pnlheight+_padding);
 }else {
RDebugUtils.currentLine=262321;
 //BA.debugLineNum = 262321;BA.debugLine="leftPosition = leftPosition + pnlWidth + p";
_leftposition = (int) (_leftposition+_pnlwidth+_padding);
 };
RDebugUtils.currentLine=262323;
 //BA.debugLineNum = 262323;BA.debugLine="scrollHeight = scrollHeight + 175dip";
_scrollheight = (int) (_scrollheight+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (175)));
 }else {
RDebugUtils.currentLine=262325;
 //BA.debugLineNum = 262325;BA.debugLine="topPosition = topPosition + pnlHeight + pad";
_topposition = (int) (_topposition+_pnlheight+_padding);
RDebugUtils.currentLine=262326;
 //BA.debugLineNum = 262326;BA.debugLine="scrollHeight = scrollHeight + 300dip + padd";
...
RDebugUtils.currentLine=262330;
 //BA.debugLineNum = 262330;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=262331;
 //BA.debugLineNum = 262331;BA.debugLine="cd.Initialize2(Colors.White, 0dip, 1dip, Col";
...
RDebugUtils.currentLine=262332;
 //BA.debugLineNum = 262332;BA.debugLine="Panel.Background = cd";
_panel.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 }
};
RDebugUtils.currentLine=262335;
 //BA.debugLineNum = 262335;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
_totalcompanies = _salesarray.getSize();
RDebugUtils.currentLine=262336;
 //BA.debugLineNum = 262336;BA.debugLine="Dim sales(totalCompanies) As Int";
_sales = new int[_totalcompanies];
;
RDebugUtils.currentLine=262337;
 //BA.debugLineNum = 262337;BA.debugLine="Dim sales1(totalCompanies) As Int";
_sales1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262338;
 //BA.debugLineNum = 262338;BA.debugLine="Dim sales2(totalCompanies) As Int";
_sales2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262339;
 //BA.debugLineNum = 262339;BA.debugLine="Dim purchase(totalCompanies) As Int";
_purchase = new int[_totalcompanies];
;
RDebugUtils.currentLine=262340;
 //BA.debugLineNum = 262340;BA.debugLine="Dim purchase1(totalCompanies) As Int";
_purchase1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262341;
 //BA.debugLineNum = 262341;BA.debugLine="Dim purchase2(totalCompanies) As Int";
_purchase2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262342;
 //BA.debugLineNum = 262342;BA.debugLine="Dim companyName(totalCompanies) As String";
_companyname = new String[_totalcompanies];
java.util.Arrays.fill(_companyname,"");
RDebugUtils.currentLine=262343;
 //BA.debugLineNum = 262343;BA.debugLine="Dim max_value(totalCompanies) As Int";
_max_value = new int[_totalcompanies];
;
RDebugUtils.currentLine=262344;
 //BA.debugLineNum = 262344;BA.debugLine="Dim maxSale As Int=0";
_maxsale = (int) (0);
RDebugUtils.currentLine=262346;
 //BA.debugLineNum = 262346;BA.debugLine="For i = 0 To totalCompanies - 1";
{
final int step137 = 1;
...
RDebugUtils.currentLine=262347;
 //BA.debugLineNum = 262347;BA.debugLine="Dim record As Map = salesArray.Get(i)";
_record = new anywheresoftware.b4a.objects.collections.Map();
_record = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_salesarray.Get(_i)));
RDebugUtils.currentLine=262348;
 //BA.debugLineNum = 262348;BA.debugLine="companyName(i) = record.GetDefault(\"company_";
_companyname[_i] = BA.ObjectToString(_record.GetDefault((Object)("company_name"),(Object)("Unknown")));
RDebugUtils.currentLine=262349;
 //BA.debugLineNum = 262349;BA.debugLine="sales(i) = record.GetDefault(\"sales_1\", 0)";
_sales[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("sales_1"),(Object)(0))));
RDebugUtils.currentLine=262350;
 //BA.debugLineNum = 262350;BA.debugLine="sales1(i) = record.GetDefault(\"sales_2\", 0)";
_sales1[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("sales_2"),(Object)(0))));
RDebugUtils.currentLine=262351;
 //BA.debugLineNum = 262351;BA.debugLine="sales2(i) = record.GetDefault(\"sales_3\", 0)";
_sales2[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("sales_3"),(Object)(0))));
RDebugUtils.currentLine=262352;
 //BA.debugLineNum = 262352;BA.debugLine="purchase(i) = record.GetDefault(\"purchase_1\"";
_purchase[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_1"),(Object)(0))));
RDebugUtils.currentLine=262353;
 //BA.debugLineNum = 262353;BA.debugLine="purchase1(i) = record.GetDefault(\"purchase_2";
_purchase1[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_2"),(Object)(0))));
RDebugUtils.currentLine=262354;
 //BA.debugLineNum = 262354;BA.debugLine="purchase2(i) = record.GetDefault(\"purchase_\"";
_purchase2[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_"),(Object)(0))));
RDebugUtils.currentLine=262355;
 //BA.debugLineNum = 262355;BA.debugLine="max_value(i) = record.GetDefault(\"max_value\"";
_max_value[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("max_value"),(Object)(0))));
RDebugUtils.currentLine=262356;
 //BA.debugLineNum = 262356;BA.debugLine="maxSale = Max(maxSale, max_value(i))";
_maxsale = (int) (anywheresoftware.b4a.keywords.Common.Max(_maxsale,_max_value[_i]));
 }
};
RDebugUtils.currentLine=262359;
 //BA.debugLineNum = 262359;BA.debugLine="Log(maxSale)";
anywheresoftware.b4a.keywords.Common.LogImpl("8262359",BA.NumberToString(_maxsale),0);
RDebugUtils.currentLine=262360;
 //BA.debugLineNum = 262360;BA.debugLine="barPanel.RemoveAllViews";
mostCurrent._barpanel.RemoveAllViews();
RDebugUtils.currentLine=262361;
 //BA.debugLineNum = 262361;BA.debugLine="barPanel.Invalidate ' Force redraw";
mostCurrent._barpanel.Invalidate();
RDebugUtils.currentLine=262363;
 //BA.debugLineNum = 262363;BA.debugLine="Dim legend() As String = Array As String(\"Sal";
mostCurrent._legend = new String[]{"Sales1","Sales2","Sales3"};
RDebugUtils.currentLine=262364;
 //BA.debugLineNum = 262364;BA.debugLine="barGraph.Initialize(Activity, barPanel, sales";
mostCurrent._bargraph._initialize /*String*/ (null,mostCurrent.activityBA,mostCurrent._activity,mostCurrent._barpanel,_sales,_sales1,_sales2,_companyname,mostCurrent._legend,_maxsale,"Total Sales of the Company");
RDebugUtils.currentLine=262365;
 //BA.debugLineNum = 262365;BA.debugLine="legend = Array As String(\"Purchase1\",\"Purchas";
mostCurrent._legend = new String[]{"Purchase1","Purchase2","Purchase3"};
RDebugUtils.currentLine=262366;
 //BA.debugLineNum = 262366;BA.debugLine="barGraph1.Initialize(Activity, purchasePanel,";
...
RDebugUtils.currentLine=262369;
 //BA.debugLineNum = 262369;BA.debugLine="ToastMessageShow(\"Data updated successfully\",";
...
RDebugUtils.currentLine=262370;
 //BA.debugLineNum = 262370;BA.debugLine="LoadCompanyData";
_loadcompanydata();
 break; }
default: {
RDebugUtils.currentLine=262372;
 //BA.debugLineNum = 262372;BA.debugLine="Log(\"Unknown job: \" & job.JobName)";
anywheresoftware.b4a.keywords.Common.LogImpl("8262372","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
       catch (Exception e163) {
			processBA.setLastException(e163);RDebugUtils.currentLine=262375;
 //BA.debugLineNum = 262375;BA.debugLine="ToastMessageShow(\"Error parsing sales data\", Tr";
...
RDebugUtils.currentLine=262378;
 //BA.debugLineNum = 262378;BA.debugLine="ToastMessageShow(\"Error: \" & job.ErrorMessage, T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Error: "+_job._errormessage /*String*/ ),anywheresoftware.b4a.keywords.Common.True);
 };
RDebugUtils.currentLine=262380;
 //BA.debugLineNum = 262380;BA.debugLine="job.Release";
_job._release /*String*/ (null);
RDebugUtils.currentLine=262381;
 //BA.debugLineNum = 262381;BA.debugLine="End Sub";
return "";
}
