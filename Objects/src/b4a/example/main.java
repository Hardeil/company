...
anywheresoftware.b4a.keywords.Common.LogImpl("5262154","LoadGraphData Error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
...
RDebugUtils.currentLine=327711;
 //BA.debugLineNum = 327711;BA.debugLine="Dim company_id As Int = record.Get(\"comId\")";
...
anywheresoftware.b4a.keywords.Common.LogImpl("5327865",_companyname[_i]+BA.NumberToString(_sales[_i]),0);
 }
};
...
RDebugUtils.currentLine=327883;
 //BA.debugLineNum = 327883;BA.debugLine="ScrollView1.Panel.AddView(totalSalePanel,5dip";
...
RDebugUtils.currentLine=327890;
 //BA.debugLineNum = 327890;BA.debugLine="totalSaleLabel.Gravity = Gravity.CENTER_VERTI";
...
RDebugUtils.currentLine=327896;
 //BA.debugLineNum = 327896;BA.debugLine="ScrollView1.Panel.AddView(barPanel,25dip,tota";
...
RDebugUtils.currentLine=327903;
 //BA.debugLineNum = 327903;BA.debugLine="barGraph.Initialize(Activity,barPanel,sales,s";
...
RDebugUtils.currentLine=327904;
 //BA.debugLineNum = 327904;BA.debugLine="legend = Array As String(\"Purchase1\",\"Purchas";
...
RDebugUtils.currentLine=327923;
 //BA.debugLineNum = 327923;BA.debugLine="totalPurchaseLabel.Gravity = Gravity.CENTER_V";
...
RDebugUtils.currentLine=327924;
 //BA.debugLineNum = 327924;BA.debugLine="totalPurchaseLabel.Typeface = Typeface.MONOSP";
...
RDebugUtils.currentLine=327931;
 //BA.debugLineNum = 327931;BA.debugLine="ScrollView1.Panel.AddView(shadowPurchPanel, 2";
...
RDebugUtils.currentLine=327935;
 //BA.debugLineNum = 327935;BA.debugLine="ScrollView1.Panel.AddView(purchasePanel,25dip";
...
RDebugUtils.currentLine=327946;
 //BA.debugLineNum = 327946;BA.debugLine="Log($\"maxSale:${maxSale}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("5327946",("maxSale:"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_maxsale))+""),0);
...
RDebugUtils.currentLine=327958;
 //BA.debugLineNum = 327958;BA.debugLine="barGraph.SetCurrentPage(currentPage) ' Update";
...
anywheresoftware.b4a.keywords.Common.LogImpl("5327964","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
