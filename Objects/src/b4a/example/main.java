...
public anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper _showdetailbutton = null;
...
RDebugUtils.currentLine=131087;
 //BA.debugLineNum = 131087;BA.debugLine="barPanel.Initialize(\"\")";
mostCurrent._barpanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=131088;
 //BA.debugLineNum = 131088;BA.debugLine="purchasePanel.Initialize(\"\")";
mostCurrent._purchasepanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=131089;
 //BA.debugLineNum = 131089;BA.debugLine="companyPanel.Initialize(\"Panel\")";
mostCurrent._companypanel.Initialize(mostCurrent.activityBA,"Panel");
RDebugUtils.currentLine=131091;
 //BA.debugLineNum = 131091;BA.debugLine="LoadCompanyData";
_loadcompanydata();
RDebugUtils.currentLine=131092;
 //BA.debugLineNum = 131092;BA.debugLine="LoadGraphData";
_loadgraphdata();
RDebugUtils.currentLine=131093;
 //BA.debugLineNum = 131093;BA.debugLine="LoadGraphDataPurchase";
...
anywheresoftware.b4a.keywords.Common.LogImpl("5262152","LoadGraphData Error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5327688","LoadGraphData Error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5851970","Default sorting applied",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5917506","Default sorting applied for purchases",0);
...
RDebugUtils.currentLine=393223;
 //BA.debugLineNum = 393223;BA.debugLine="Select Case job.JobName";
switch (BA.switchObjectToInt(_job._jobname /*String*/ ,"GetData","GetCompany","GetCompanyPurchase","UpdateData")) {
case 0: {
RDebugUtils.currentLine=393225;
 //BA.debugLineNum = 393225;BA.debugLine="Dim salesArray As List = parser.NextArray";
_salesarray = new anywheresoftware.b4a.objects.collections.List();
_salesarray = _parser.NextArray();
RDebugUtils.currentLine=393226;
 //BA.debugLineNum = 393226;BA.debugLine="If salesArray.Size = 0 Then";
if (_salesarray.getSize()==0) { 
RDebugUtils.currentLine=393227;
 //BA.debugLineNum = 393227;BA.debugLine="ToastMessageShow(\"No data received\", True)";
...
RDebugUtils.currentLine=393228;
 //BA.debugLineNum = 393228;BA.debugLine="Return";
if (true) return "";
 };
RDebugUtils.currentLine=393230;
 //BA.debugLineNum = 393230;BA.debugLine="Dim padding As Int = 10dip";
_padding = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
RDebugUtils.currentLine=393231;
 //BA.debugLineNum = 393231;BA.debugLine="Dim count As Int = 0";
_count = (int) (0);
RDebugUtils.currentLine=393232;
 //BA.debugLineNum = 393232;BA.debugLine="Dim rowNum As Int = 3";
_rownum = (int) (3);
RDebugUtils.currentLine=393233;
 //BA.debugLineNum = 393233;BA.debugLine="Dim mainPanelWidth As Int = 0";
_mainpanelwidth = (int) (0);
RDebugUtils.currentLine=393234;
 //BA.debugLineNum = 393234;BA.debugLine="Dim panelHeight As Int = 150dip";
_panelheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150));
RDebugUtils.currentLine=393235;
 //BA.debugLineNum = 393235;BA.debugLine="height = panelHeight - 70dip";
_height = (int) (_panelheight-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (70)));
RDebugUtils.currentLine=393236;
 //BA.debugLineNum = 393236;BA.debugLine="For Each record As Map In salesArray";
_record = new anywheresoftware.b4a.objects.collections.Map();
{
final anywheresoftware.b4a.BA.IterableList group19 = _salesarray;
final int groupLen19 = group19.getSize()
;int index19 = 0;
;
for (; index19 < groupLen19;index19++){
_record = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group19.Get(index19)));
RDebugUtils.currentLine=393237;
 //BA.debugLineNum = 393237;BA.debugLine="If count Mod 3 = 0 Then height = height + pa";
if (_count%3==0) { 
_height = (int) (_height+_panelheight);};
RDebugUtils.currentLine=393238;
 //BA.debugLineNum = 393238;BA.debugLine="Dim col As Int = count Mod 3";
_col = (int) (_count%3);
RDebugUtils.currentLine=393239;
 //BA.debugLineNum = 393239;BA.debugLine="Dim row As Int = Floor(count / 3)";
_row = (int) (anywheresoftware.b4a.keywords.Common.Floor(_count/(double)3));
RDebugUtils.currentLine=393240;
 //BA.debugLineNum = 393240;BA.debugLine="Dim name As String = record.Get(\"company_nam";
_name = BA.ObjectToString(_record.Get((Object)("company_name")));
RDebugUtils.currentLine=393241;
 //BA.debugLineNum = 393241;BA.debugLine="Dim company_id As Int = record.Get(\"company_";
_company_id = (int)(BA.ObjectToNumber(_record.Get((Object)("company_id"))));
RDebugUtils.currentLine=393242;
 //BA.debugLineNum = 393242;BA.debugLine="Dim total_count As Int = record.Get(\"total_b";
_total_count = (int)(BA.ObjectToNumber(_record.Get((Object)("total_branch_count"))));
RDebugUtils.currentLine=393243;
 //BA.debugLineNum = 393243;BA.debugLine="Dim total_pos As Int = record.Get(\"totalDevi";
_total_pos = (int)(BA.ObjectToNumber(_record.Get((Object)("totalDevices"))));
RDebugUtils.currentLine=393244;
 //BA.debugLineNum = 393244;BA.debugLine="Dim dashPanel As Panel";
_dashpanel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=393245;
 //BA.debugLineNum = 393245;BA.debugLine="dashPanel.Initialize(\"\")";
_dashpanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393246;
 //BA.debugLineNum = 393246;BA.debugLine="ScrollView1.Panel.AddView(dashPanel, 5dip, P";
...
RDebugUtils.currentLine=393248;
 //BA.debugLineNum = 393248;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
...
RDebugUtils.currentLine=393255;
 //BA.debugLineNum = 393255;BA.debugLine="Dim dashLabel As Label";
_dashlabel = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=393256;
 //BA.debugLineNum = 393256;BA.debugLine="dashLabel.Initialize(\"\")";
_dashlabel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393257;
 //BA.debugLineNum = 393257;BA.debugLine="dashLabel.Text = \"Dashboard\"";
_dashlabel.setText(BA.ObjectToCharSequence("Dashboard"));
RDebugUtils.currentLine=393258;
 //BA.debugLineNum = 393258;BA.debugLine="dashLabel.TextColor = Colors.ARGB(50, 156, 0";
...
RDebugUtils.currentLine=393259;
 //BA.debugLineNum = 393259;BA.debugLine="dashLabel.Gravity = Gravity.CENTER_VERTICAL";
_dashlabel.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
RDebugUtils.currentLine=393260;
 //BA.debugLineNum = 393260;BA.debugLine="dashLabel.Typeface = Typeface.MONOSPACE";
_dashlabel.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.MONOSPACE);
RDebugUtils.currentLine=393261;
 //BA.debugLineNum = 393261;BA.debugLine="dashPanel.AddView(dashLabel, imgView.Width +";
...
RDebugUtils.currentLine=393262;
 //BA.debugLineNum = 393262;BA.debugLine="calculatedSize = AdjustFontSizeToHeight(dash";
_calculatedsize = _adjustfontsizetoheight(_dashlabel,(float) (2));
RDebugUtils.currentLine=393263;
 //BA.debugLineNum = 393263;BA.debugLine="dashLabel.TextSize = calculatedSize";
_dashlabel.setTextSize(_calculatedsize);
RDebugUtils.currentLine=393265;
 //BA.debugLineNum = 393265;BA.debugLine="companyPanel.Initialize(\"Panel\")";
mostCurrent._companypanel.Initialize(mostCurrent.activityBA,"Panel");
RDebugUtils.currentLine=393266;
 //BA.debugLineNum = 393266;BA.debugLine="ScrollView1.Panel.AddView(companyPanel, 5dip";
...
RDebugUtils.currentLine=393268;
 //BA.debugLineNum = 393268;BA.debugLine="mainPanelWidth = companyPanel.Width / rowNum";
_mainpanelwidth = (int) (mostCurrent._companypanel.getWidth()/(double)_rownum);
RDebugUtils.currentLine=393269;
 //BA.debugLineNum = 393269;BA.debugLine="Dim Panel As Panel";
_panel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=393270;
 //BA.debugLineNum = 393270;BA.debugLine="Panel.Initialize(\"\")";
_panel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393271;
 //BA.debugLineNum = 393271;BA.debugLine="companyPanel.AddView(Panel, col * (mainPanel";
...
RDebugUtils.currentLine=393289;
 //BA.debugLineNum = 393289;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
_myimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
...
RDebugUtils.currentLine=393290;
 //BA.debugLineNum = 393290;BA.debugLine="If myImage.IsInitialized Then";
if (_myimage.IsInitialized()) { 
RDebugUtils.currentLine=393291;
 //BA.debugLineNum = 393291;BA.debugLine="Dim resizedImage As Bitmap = myImage.Resize";
...
RDebugUtils.currentLine=393292;
 //BA.debugLineNum = 393292;BA.debugLine="Dim imgView As ImageView";
_imgview = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=393293;
 //BA.debugLineNum = 393293;BA.debugLine="imgView.Initialize(\"\")";
_imgview.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393294;
 //BA.debugLineNum = 393294;BA.debugLine="imgView.Gravity = Gravity.FILL";
_imgview.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
RDebugUtils.currentLine=393295;
 //BA.debugLineNum = 393295;BA.debugLine="imgView.Bitmap = myImage";
_imgview.setBitmap((android.graphics.Bitmap)(_myimage.getObject()));
RDebugUtils.currentLine=393296;
 //BA.debugLineNum = 393296;BA.debugLine="PanelTitle.AddView(imgView, PanelTitle.Widt";
...
RDebugUtils.currentLine=393298;
 //BA.debugLineNum = 393298;BA.debugLine="Log(\"Error loading image\")";
anywheresoftware.b4a.keywords.Common.LogImpl("5393298","Error loading image",0);
 };
RDebugUtils.currentLine=393301;
 //BA.debugLineNum = 393301;BA.debugLine="Dim panelWidth As Int = Panel.Width / 3";
_panelwidth = (int) (_panel.getWidth()/(double)3);
RDebugUtils.currentLine=393302;
 //BA.debugLineNum = 393302;BA.debugLine="Dim padding As Int = 10dip";
_padding = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
RDebugUtils.currentLine=393303;
 //BA.debugLineNum = 393303;BA.debugLine="Dim labelheight As Int = panelHeight - Panel";
_labelheight = (int) (_panelheight-_paneltitle.getHeight());
RDebugUtils.currentLine=393304;
 //BA.debugLineNum = 393304;BA.debugLine="panelWidth = Panel.Width / 2";
_panelwidth = (int) (_panel.getWidth()/(double)2);
RDebugUtils.currentLine=393306;
 //BA.debugLineNum = 393306;BA.debugLine="Dim totalStore As Label";
_totalstore = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=393307;
 //BA.debugLineNum = 393307;BA.debugLine="totalStore.Initialize(\"\")";
_totalstore.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393308;
 //BA.debugLineNum = 393308;BA.debugLine="totalStore.Text = total_count";
_totalstore.setText(BA.ObjectToCharSequence(_total_count));
RDebugUtils.currentLine=393309;
 //BA.debugLineNum = 393309;BA.debugLine="totalStore.TextColor = Colors.Black";
_totalstore.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=393310;
 //BA.debugLineNum = 393310;BA.debugLine="totalStore.TextSize = primaryFontSize";
_totalstore.setTextSize((float) (_primaryfontsize));
RDebugUtils.currentLine=393311;
 //BA.debugLineNum = 393311;BA.debugLine="totalStore.Gravity = Gravity.CENTER";
_totalstore.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
RDebugUtils.currentLine=393312;
 //BA.debugLineNum = 393312;BA.debugLine="totalStore.Typeface = Typeface.SERIF";
_totalstore.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.SERIF);
RDebugUtils.currentLine=393313;
 //BA.debugLineNum = 393313;BA.debugLine="Panel.AddView(totalStore, 0, PanelTitle.Heig";
...
RDebugUtils.currentLine=393344;
 //BA.debugLineNum = 393344;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=393345;
 //BA.debugLineNum = 393345;BA.debugLine="cd.Initialize2(Colors.White, 0dip, 0dip, Col";
...
RDebugUtils.currentLine=393346;
 //BA.debugLineNum = 393346;BA.debugLine="Panel.Background = cd";
_panel.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
RDebugUtils.currentLine=393347;
 //BA.debugLineNum = 393347;BA.debugLine="count = count + 1";
_count = (int) (_count+1);
 }
};
RDebugUtils.currentLine=393349;
 //BA.debugLineNum = 393349;BA.debugLine="totalGetDataHeight = Panel2.Height + companyP";
_totalgetdataheight = (int) (mostCurrent._panel2.getHeight()+mostCurrent._companypanel.getHeight());
 break; }
case 1: {
RDebugUtils.currentLine=393352;
 //BA.debugLineNum = 393352;BA.debugLine="Dim salesArray As List = parser.NextArray";
_salesarray = new anywheresoftware.b4a.objects.collections.List();
_salesarray = _parser.NextArray();
RDebugUtils.currentLine=393353;
 //BA.debugLineNum = 393353;BA.debugLine="If salesArray.Size = 0 Then";
if (_salesarray.getSize()==0) { 
RDebugUtils.currentLine=393354;
 //BA.debugLineNum = 393354;BA.debugLine="ToastMessageShow(\"No data received\", True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("No data received"),anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=393355;
 //BA.debugLineNum = 393355;BA.debugLine="Return";
if (true) return "";
 };
RDebugUtils.currentLine=393358;
 //BA.debugLineNum = 393358;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
_totalcompanies = _salesarray.getSize();
RDebugUtils.currentLine=393359;
 //BA.debugLineNum = 393359;BA.debugLine="Dim sales(totalCompanies) As Int";
_sales = new int[_totalcompanies];
;
RDebugUtils.currentLine=393360;
 //BA.debugLineNum = 393360;BA.debugLine="Dim comId(totalCompanies) As Int";
_comid = new int[_totalcompanies];
;
RDebugUtils.currentLine=393361;
 //BA.debugLineNum = 393361;BA.debugLine="Dim sales1(totalCompanies) As Int";
_sales1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=393362;
 //BA.debugLineNum = 393362;BA.debugLine="Dim sales2(totalCompanies) As Int";
_sales2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=393363;
 //BA.debugLineNum = 393363;BA.debugLine="Dim purchase(totalCompanies) As Int";
_purchase = new int[_totalcompanies];
;
RDebugUtils.currentLine=393364;
 //BA.debugLineNum = 393364;BA.debugLine="Dim purchase1(totalCompanies) As Int";
_purchase1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=393365;
 //BA.debugLineNum = 393365;BA.debugLine="Dim purchase2(totalCompanies) As Int";
_purchase2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=393366;
 //BA.debugLineNum = 393366;BA.debugLine="Dim companyName(totalCompanies) As String";
_companyname = new String[_totalcompanies];
java.util.Arrays.fill(_companyname,"");
RDebugUtils.currentLine=393367;
 //BA.debugLineNum = 393367;BA.debugLine="Dim max_value(totalCompanies) As Int";
_max_value = new int[_totalcompanies];
;
RDebugUtils.currentLine=393368;
 //BA.debugLineNum = 393368;BA.debugLine="Dim maxSale As Int = 0";
_maxsale = (int) (0);
RDebugUtils.currentLine=393370;
 //BA.debugLineNum = 393370;BA.debugLine="For i = 0 To totalCompanies - 1";
{
final int step137 = 1;
final int limit137 = (int) (_totalcompanies-1);
_i = (int) (0) ;
for (;_i <= limit137 ;_i = _i + step137 ) {
RDebugUtils.currentLine=393371;
 //BA.debugLineNum = 393371;BA.debugLine="Dim record As Map = salesArray.Get(i)";
_record = new anywheresoftware.b4a.objects.collections.Map();
...
RDebugUtils.currentLine=393399;
 //BA.debugLineNum = 393399;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
_myimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
...
RDebugUtils.currentLine=393400;
 //BA.debugLineNum = 393400;BA.debugLine="Dim imgView As ImageView";
_imgview = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=393401;
 //BA.debugLineNum = 393401;BA.debugLine="imgView.Initialize(\"\")";
_imgview.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393402;
 //BA.debugLineNum = 393402;BA.debugLine="imgView.Gravity = Gravity.FILL";
_imgview.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
RDebugUtils.currentLine=393403;
 //BA.debugLineNum = 393403;BA.debugLine="imgView.Bitmap = myImage";
_imgview.setBitmap((android.graphics.Bitmap)(_myimage.getObject()));
RDebugUtils.currentLine=393404;
 //BA.debugLineNum = 393404;BA.debugLine="totalSalePanel.AddView(imgView, 0dip, 12.5di";
...
RDebugUtils.currentLine=393413;
 //BA.debugLineNum = 393413;BA.debugLine="AdjustFontSizeToHeight(totalSaleLabel, 2)";
_adjustfontsizetoheight(_totalsalelabel,(float) (2));
RDebugUtils.currentLine=393415;
 //BA.debugLineNum = 393415;BA.debugLine="ScrollView1.Panel.AddView(barPanel, 25dip, t";
...
RDebugUtils.currentLine=393416;
 //BA.debugLineNum = 393416;BA.debugLine="barPanel.Color = Colors.White";
mostCurrent._barpanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=393417;
 //BA.debugLineNum = 393417;BA.debugLine="barPanel.RemoveAllViews";
mostCurrent._barpanel.RemoveAllViews();
RDebugUtils.currentLine=393418;
 //BA.debugLineNum = 393418;BA.debugLine="barPanel.Invalidate";
mostCurrent._barpanel.Invalidate();
RDebugUtils.currentLine=393420;
 //BA.debugLineNum = 393420;BA.debugLine="barGraph.Initialize(Activity, barPanel, sale";
...
RDebugUtils.currentLine=393421;
 //BA.debugLineNum = 393421;BA.debugLine="barGraphInitialized = True";
_bargraphinitialized = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=393422;
 //BA.debugLineNum = 393422;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 }else {
RDebugUtils.currentLine=393424;
 //BA.debugLineNum = 393424;BA.debugLine="barGraph.sale_1 = sales";
mostCurrent._bargraph._sale_1 /*int[]*/  = _sales;
RDebugUtils.currentLine=393425;
 //BA.debugLineNum = 393425;BA.debugLine="barGraph.sale_2 = sales1";
mostCurrent._bargraph._sale_2 /*int[]*/  = _sales1;
RDebugUtils.currentLine=393426;
 //BA.debugLineNum = 393426;BA.debugLine="barGraph.sale_3 = sales2";
mostCurrent._bargraph._sale_3 /*int[]*/  = _sales2;
RDebugUtils.currentLine=393427;
 //BA.debugLineNum = 393427;BA.debugLine="barGraph.product1 = companyName";
mostCurrent._bargraph._product1 /*String[]*/  = _companyname;
RDebugUtils.currentLine=393428;
 //BA.debugLineNum = 393428;BA.debugLine="barGraph.comId1 = comId ' Corrected to use c";
mostCurrent._bargraph._comid1 /*int[]*/  = _comid;
RDebugUtils.currentLine=393429;
 //BA.debugLineNum = 393429;BA.debugLine="barGraph.UpdateGraph";
mostCurrent._bargraph._updategraph /*String*/ (null);
 };
 break; }
case 2: {
RDebugUtils.currentLine=393433;
 //BA.debugLineNum = 393433;BA.debugLine="Dim salesArray As List = parser.NextArray";
_salesarray = new anywheresoftware.b4a.objects.collections.List();
_salesarray = _parser.NextArray();
RDebugUtils.currentLine=393434;
 //BA.debugLineNum = 393434;BA.debugLine="If salesArray.Size = 0 Then";
if (_salesarray.getSize()==0) { 
RDebugUtils.currentLine=393435;
 //BA.debugLineNum = 393435;BA.debugLine="ToastMessageShow(\"No data received\", True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("No data received"),anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=393436;
 //BA.debugLineNum = 393436;BA.debugLine="Return";
if (true) return "";
 };
RDebugUtils.currentLine=393439;
 //BA.debugLineNum = 393439;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
_totalcompanies = _salesarray.getSize();
RDebugUtils.currentLine=393440;
 //BA.debugLineNum = 393440;BA.debugLine="Dim purchase(totalCompanies) As Int";
_purchase = new int[_totalcompanies];
;
RDebugUtils.currentLine=393441;
 //BA.debugLineNum = 393441;BA.debugLine="Dim purchase1(totalCompanies) As Int";
_purchase1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=393442;
 //BA.debugLineNum = 393442;BA.debugLine="Dim purchase2(totalCompanies) As Int";
_purchase2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=393443;
 //BA.debugLineNum = 393443;BA.debugLine="Dim companyName(totalCompanies) As String";
_companyname = new String[_totalcompanies];
java.util.Arrays.fill(_companyname,"");
RDebugUtils.currentLine=393444;
 //BA.debugLineNum = 393444;BA.debugLine="Dim comId(totalCompanies) As Int";
_comid = new int[_totalcompanies];
;
RDebugUtils.currentLine=393445;
 //BA.debugLineNum = 393445;BA.debugLine="Dim maxSale As Int = 0";
_maxsale = (int) (0);
RDebugUtils.currentLine=393447;
 //BA.debugLineNum = 393447;BA.debugLine="For i = 0 To totalCompanies - 1";
{
final int step206 = 1;
final int limit206 = (int) (_totalcompanies-1);
_i = (int) (0) ;
for (;_i <= limit206 ;_i = _i + step206 ) {
RDebugUtils.currentLine=393448;
 //BA.debugLineNum = 393448;BA.debugLine="Dim record As Map = salesArray.Get(i)";
_record = new anywheresoftware.b4a.objects.collections.Map();
_record = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_salesarray.Get(_i)));
RDebugUtils.currentLine=393449;
 //BA.debugLineNum = 393449;BA.debugLine="companyName(i) = record.GetDefault(\"company_";
_companyname[_i] = BA.ObjectToString(_record.GetDefault((Object)("company_name"),(Object)("Unknown")));
RDebugUtils.currentLine=393450;
 //BA.debugLineNum = 393450;BA.debugLine="comId(i) = record.GetDefault(\"comId\", 0)";
_comid[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("comId"),(Object)(0))));
RDebugUtils.currentLine=393451;
 //BA.debugLineNum = 393451;BA.debugLine="purchase(i) = record.GetDefault(\"purchase_1\"";
_purchase[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_1"),(Object)(0))));
RDebugUtils.currentLine=393452;
 //BA.debugLineNum = 393452;BA.debugLine="purchase1(i) = record.GetDefault(\"purchase_2";
_purchase1[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_2"),(Object)(0))));
RDebugUtils.currentLine=393453;
 //BA.debugLineNum = 393453;BA.debugLine="purchase2(i) = record.GetDefault(\"purchase_3";
_purchase2[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_3"),(Object)(0))));
RDebugUtils.currentLine=393454;
 //BA.debugLineNum = 393454;BA.debugLine="maxSale = Max(maxSale, record.GetDefault(\"ma";
...
RDebugUtils.currentLine=393457;
 //BA.debugLineNum = 393457;BA.debugLine="If Not(barGraphInitializedPurchase) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_bargraphinitializedpurchase)) { 
RDebugUtils.currentLine=393458;
 //BA.debugLineNum = 393458;BA.debugLine="purchNxtBtn.Initialize(\"purchNxtBtn\")";
mostCurrent._purchnxtbtn.Initialize(mostCurrent.activityBA,"purchNxtBtn");
RDebugUtils.currentLine=393459;
 //BA.debugLineNum = 393459;BA.debugLine="purchBackBtn.Initialize(\"purchBackBtn\")";
mostCurrent._purchbackbtn.Initialize(mostCurrent.activityBA,"purchBackBtn");
RDebugUtils.currentLine=393460;
 //BA.debugLineNum = 393460;BA.debugLine="sortBtnPurchase1.Initialize(\"sortBtnPurchase";
mostCurrent._sortbtnpurchase1.Initialize(mostCurrent.activityBA,"sortBtnPurchase1");
RDebugUtils.currentLine=393461;
 //BA.debugLineNum = 393461;BA.debugLine="sortBtnPurchase2.Initialize(\"sortBtnPurchase";
mostCurrent._sortbtnpurchase2.Initialize(mostCurrent.activityBA,"sortBtnPurchase2");
RDebugUtils.currentLine=393462;
 //BA.debugLineNum = 393462;BA.debugLine="defBtnPurchase.Initialize(\"defBtnPurchase\")";
mostCurrent._defbtnpurchase.Initialize(mostCurrent.activityBA,"defBtnPurchase");
RDebugUtils.currentLine=393463;
 //BA.debugLineNum = 393463;BA.debugLine="purch1btn.Initialize(\"purch1btn\")";
mostCurrent._purch1btn.Initialize(mostCurrent.activityBA,"purch1btn");
RDebugUtils.currentLine=393464;
 //BA.debugLineNum = 393464;BA.debugLine="purch2btn.Initialize(\"purch2btn\")";
mostCurrent._purch2btn.Initialize(mostCurrent.activityBA,"purch2btn");
RDebugUtils.currentLine=393465;
 //BA.debugLineNum = 393465;BA.debugLine="purch3btn.Initialize(\"purch3btn\")";
mostCurrent._purch3btn.Initialize(mostCurrent.activityBA,"purch3btn");
RDebugUtils.currentLine=393466;
 //BA.debugLineNum = 393466;BA.debugLine="showDetailButton.Initialize(\"showDetailButto";
mostCurrent._showdetailbutton.Initialize(mostCurrent.activityBA,"showDetailButton");
RDebugUtils.currentLine=393468;
 //BA.debugLineNum = 393468;BA.debugLine="Dim totalPurchasePanel As Panel";
_totalpurchasepanel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=393469;
 //BA.debugLineNum = 393469;BA.debugLine="totalPurchasePanel.Initialize(\"\")";
_totalpurchasepanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393470;
 //BA.debugLineNum = 393470;BA.debugLine="ScrollView1.Panel.AddView(totalPurchasePanel";
mostCurrent._scrollview1.getPanel().AddView((android.view.View)(_totalpurchasepanel.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),(int) (mostCurrent._barpanel.getTop()+mostCurrent._barpanel.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15))),mostCurrent._activity.getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
RDebugUtils.currentLine=393472;
 //BA.debugLineNum = 393472;BA.debugLine="Dim myImage As Bitmap = LoadBitmap(File.DirA";
_myimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
_myimage = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"stock.png");
RDebugUtils.currentLine=393473;
 //BA.debugLineNum = 393473;BA.debugLine="Dim imgView As ImageView";
_imgview = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=393474;
 //BA.debugLineNum = 393474;BA.debugLine="imgView.Initialize(\"\")";
_imgview.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393475;
 //BA.debugLineNum = 393475;BA.debugLine="imgView.Gravity = Gravity.FILL";
_imgview.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
RDebugUtils.currentLine=393476;
 //BA.debugLineNum = 393476;BA.debugLine="imgView.Bitmap = myImage";
_imgview.setBitmap((android.graphics.Bitmap)(_myimage.getObject()));
RDebugUtils.currentLine=393477;
 //BA.debugLineNum = 393477;BA.debugLine="totalPurchasePanel.AddView(imgView, 0dip, 12";
...
RDebugUtils.currentLine=393479;
 //BA.debugLineNum = 393479;BA.debugLine="Dim totalPurchaseLabel As Label";
_totalpurchaselabel = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=393480;
 //BA.debugLineNum = 393480;BA.debugLine="totalPurchaseLabel.Initialize(\"\")";
_totalpurchaselabel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=393481;
 //BA.debugLineNum = 393481;BA.debugLine="totalPurchaseLabel.Text = \"Total Purchases\"";
_totalpurchaselabel.setText(BA.ObjectToCharSequence("Total Purchases"));
RDebugUtils.currentLine=393482;
 //BA.debugLineNum = 393482;BA.debugLine="totalPurchaseLabel.TextColor = Colors.Black";
_totalpurchaselabel.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=393483;
 //BA.debugLineNum = 393483;BA.debugLine="totalPurchaseLabel.Gravity = Gravity.CENTER_";
...
RDebugUtils.currentLine=393484;
 //BA.debugLineNum = 393484;BA.debugLine="totalPurchaseLabel.Typeface = Typeface.MONOS";
_totalpurchaselabel.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.MONOSPACE);
RDebugUtils.currentLine=393485;
 //BA.debugLineNum = 393485;BA.debugLine="totalPurchasePanel.AddView(totalPurchaseLabe";
...
RDebugUtils.currentLine=393486;
 //BA.debugLineNum = 393486;BA.debugLine="AdjustFontSizeToHeight(totalPurchaseLabel, 2";
_adjustfontsizetoheight(_totalpurchaselabel,(float) (2));
RDebugUtils.currentLine=393488;
 //BA.debugLineNum = 393488;BA.debugLine="ScrollView1.Panel.AddView(purchasePanel, 25d";
mostCurrent._scrollview1.getPanel().AddView((android.view.View)(mostCurrent._purchasepanel.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),(int) (_totalpurchasepanel.getTop()+_totalpurchasepanel.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),(int) (mostCurrent._activity.getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (450)));
RDebugUtils.currentLine=393489;
 //BA.debugLineNum = 393489;BA.debugLine="purchasePanel.Color = Colors.White";
mostCurrent._purchasepanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=393490;
 //BA.debugLineNum = 393490;BA.debugLine="purchasePanel.RemoveAllViews";
mostCurrent._purchasepanel.RemoveAllViews();
RDebugUtils.currentLine=393491;
 //BA.debugLineNum = 393491;BA.debugLine="purchasePanel.Invalidate";
mostCurrent._purchasepanel.Invalidate();
RDebugUtils.currentLine=393493;
 //BA.debugLineNum = 393493;BA.debugLine="barGraphPurchase.Initialize(Activity, purcha";
mostCurrent._bargraphpurchase._initialize /*String*/ (null,mostCurrent.activityBA,mostCurrent._activity,mostCurrent._purchasepanel,_purchase,_purchase1,_purchase2,_companyname,mostCurrent._legendpurchase,_maxsale,"Total Purchase Per Company",_comid,"Branch",mostCurrent._purchnxtbtn,mostCurrent._purchbackbtn,mostCurrent._sortbtnpurchase1,mostCurrent._sortbtnpurchase2,mostCurrent._defbtnpurchase,mostCurrent._purch1btn,mostCurrent._purch2btn,mostCurrent._purch3btn);
RDebugUtils.currentLine=393494;
 //BA.debugLineNum = 393494;BA.debugLine="barGraphInitializedPurchase = True";
_bargraphinitializedpurchase = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=393495;
 //BA.debugLineNum = 393495;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 }else {
RDebugUtils.currentLine=393497;
 //BA.debugLineNum = 393497;BA.debugLine="barGraphPurchase.sale_1 = purchase ' Adjuste";
mostCurrent._bargraphpurchase._sale_1 /*int[]*/  = _purchase;
RDebugUtils.currentLine=393498;
 //BA.debugLineNum = 393498;BA.debugLine="barGraphPurchase.sale_2 = purchase1";
mostCurrent._bargraphpurchase._sale_2 /*int[]*/  = _purchase1;
RDebugUtils.currentLine=393499;
 //BA.debugLineNum = 393499;BA.debugLine="barGraphPurchase.sale_3 = purchase2";
mostCurrent._bargraphpurchase._sale_3 /*int[]*/  = _purchase2;
RDebugUtils.currentLine=393500;
 //BA.debugLineNum = 393500;BA.debugLine="barGraphPurchase.product1 = companyName";
mostCurrent._bargraphpurchase._product1 /*String[]*/  = _companyname;
RDebugUtils.currentLine=393501;
 //BA.debugLineNum = 393501;BA.debugLine="barGraphPurchase.comId1 = comId ' Corrected";
mostCurrent._bargraphpurchase._comid1 /*int[]*/  = _comid;
RDebugUtils.currentLine=393502;
 //BA.debugLineNum = 393502;BA.debugLine="barGraphPurchase.UpdateGraph";
mostCurrent._bargraphpurchase._updategraph /*String*/ (null);
 };
RDebugUtils.currentLine=393505;
 //BA.debugLineNum = 393505;BA.debugLine="ScrollView1.Panel.Height = purchasePanel.Top";
mostCurrent._scrollview1.getPanel().setHeight((int) (mostCurrent._purchasepanel.getTop()+mostCurrent._purchasepanel.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (300))));
RDebugUtils.currentLine=393506;
 //BA.debugLineNum = 393506;BA.debugLine="Log($\"maxSale:${maxSale}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("5393506",("maxSale:"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_maxsale))+""),0);
 break; }
case 3: {
RDebugUtils.currentLine=393509;
 //BA.debugLineNum = 393509;BA.debugLine="ToastMessageShow(\"Data updated successfully\",";
...
RDebugUtils.currentLine=393510;
 //BA.debugLineNum = 393510;BA.debugLine="LoadCompanyData";
_loadcompanydata();
 break; }
default: {
RDebugUtils.currentLine=393512;
 //BA.debugLineNum = 393512;BA.debugLine="Log(\"Unknown job: \" & job.JobName)";
anywheresoftware.b4a.keywords.Common.LogImpl("5393512","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
       catch (Exception e266) {
			processBA.setLastException(e266);RDebugUtils.currentLine=393516;
 //BA.debugLineNum = 393516;BA.debugLine="Log(\"Error parsing data: \" & LastException.Mess";
anywheresoftware.b4a.keywords.Common.LogImpl("5393516","Error parsing data: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 }else {
RDebugUtils.currentLine=393519;
 //BA.debugLineNum = 393519;BA.debugLine="ToastMessageShow(\"Error: \" & job.ErrorMessage, T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Error: "+_job._errormessage /*String*/ ),anywheresoftware.b4a.keywords.Common.True);
 };
RDebugUtils.currentLine=393521;
 //BA.debugLineNum = 393521;BA.debugLine="job.Release";
_job._release /*String*/ (null);
RDebugUtils.currentLine=393522;
 //BA.debugLineNum = 393522;BA.debugLine="End Sub";
return "";
}
...
anywheresoftware.b4a.keywords.Common.LogImpl("51310722","Purchase 1 selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51376258","Purchase 2 selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51441794","Purchase 3 selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5983042","Sales 1 selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51048578","Sales 2 selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51114114","Sales 3 selected",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5786437",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51179653",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51245189",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
