...
RDebugUtils.currentLine=5439488;
 //BA.debugLineNum = 5439488;BA.debugLine="Sub GetMapValueOrDefault(m As Map, Key As String,";
RDebugUtils.currentLine=5439489;
 //BA.debugLineNum = 5439489;BA.debugLine="If m.ContainsKey(Key) Then";
if (_m.ContainsKey((Object)(_key))) { 
RDebugUtils.currentLine=5439490;
 //BA.debugLineNum = 5439490;BA.debugLine="Return m.Get(Key)";
if (true) return _m.Get((Object)(_key));
 }else {
RDebugUtils.currentLine=5439492;
 //BA.debugLineNum = 5439492;BA.debugLine="Return DefaultValue";
...
int _j = 0;
anywheresoftware.b4a.objects.collections.Map _specificbranch = null;
...
RDebugUtils.currentLine=262152;
 //BA.debugLineNum = 262152;BA.debugLine="Dim scrollHeight As Int = 0";
_scrollheight = (int) (0);
RDebugUtils.currentLine=262153;
 //BA.debugLineNum = 262153;BA.debugLine="Dim salesArray As List = parser.NextArray";
_salesarray = new anywheresoftware.b4a.objects.collections.List();
_salesarray = _parser.NextArray();
RDebugUtils.currentLine=262157;
 //BA.debugLineNum = 262157;BA.debugLine="If salesArray.Size = 0 Then";
if (_salesarray.getSize()==0) { 
RDebugUtils.currentLine=262158;
 //BA.debugLineNum = 262158;BA.debugLine="ToastMessageShow(\"No data received\", True)";
...
RDebugUtils.currentLine=262163;
 //BA.debugLineNum = 262163;BA.debugLine="Dim numColumns As Int = 2 ' Adjust based on p";
_numcolumns = (int) (2);
RDebugUtils.currentLine=262164;
 //BA.debugLineNum = 262164;BA.debugLine="Dim pnlWidth As Int = Activity.Width - 100dip";
...
RDebugUtils.currentLine=262208;
 //BA.debugLineNum = 262208;BA.debugLine="Dim myImage As Bitmap";
_myimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
RDebugUtils.currentLine=262209;
 //BA.debugLineNum = 262209;BA.debugLine="myImage = LoadBitmap(File.DirAssets, \"arrows";
...
RDebugUtils.currentLine=262210;
 //BA.debugLineNum = 262210;BA.debugLine="If myImage.IsInitialized Then";
if (_myimage.IsInitialized()) { 
RDebugUtils.currentLine=262211;
 //BA.debugLineNum = 262211;BA.debugLine="Dim resizedImage As Bitmap = myImage.Resize";
...
RDebugUtils.currentLine=262267;
 //BA.debugLineNum = 262267;BA.debugLine="Dim branchName As String";
_branchname = "";
RDebugUtils.currentLine=262268;
 //BA.debugLineNum = 262268;BA.debugLine="Dim branchSales1 As Int";
_branchsales1 = 0;
RDebugUtils.currentLine=262269;
 //BA.debugLineNum = 262269;BA.debugLine="Dim branchSales2 As Int";
_branchsales2 = 0;
RDebugUtils.currentLine=262270;
 //BA.debugLineNum = 262270;BA.debugLine="Dim branchSales3 As Int";
_branchsales3 = 0;
RDebugUtils.currentLine=262271;
 //BA.debugLineNum = 262271;BA.debugLine="If record.ContainsKey(\"branches\") Then";
if (_record.ContainsKey((Object)("branches"))) { 
RDebugUtils.currentLine=262272;
 //BA.debugLineNum = 262272;BA.debugLine="Dim branches As List = record.Get(\"branches";
...
RDebugUtils.currentLine=262273;
 //BA.debugLineNum = 262273;BA.debugLine="For j = 0 To branches.Size - 1";
{
final int step106 = 1;
final int limit106 = (int) (_branches.getSize()-1);
_j = (int) (0) ;
for (;_j <= limit106 ;_j = _j + step106 ) {
RDebugUtils.currentLine=262274;
 //BA.debugLineNum = 262274;BA.debugLine="Dim specificbranch As Map = branches.Get(j";
_specificbranch = new anywheresoftware.b4a.objects.collections.Map();
_specificbranch = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_branches.Get(_j)));
RDebugUtils.currentLine=262275;
 //BA.debugLineNum = 262275;BA.debugLine="branchName = GetMapValueOrDefault(specific";
_branchname = BA.ObjectToString(_getmapvalueordefault(_specificbranch,"branch_name",(Object)("Unknown Branch")));
RDebugUtils.currentLine=262276;
 //BA.debugLineNum = 262276;BA.debugLine="branchSales1 = GetMapValueOrDefault(specif";
_branchsales1 = (int)(BA.ObjectToNumber(_getmapvalueordefault(_specificbranch,"sales1",(Object)(0))));
RDebugUtils.currentLine=262277;
 //BA.debugLineNum = 262277;BA.debugLine="branchSales2  = GetMapValueOrDefault(speci";
_branchsales2 = (int)(BA.ObjectToNumber(_getmapvalueordefault(_specificbranch,"sales2",(Object)(0))));
RDebugUtils.currentLine=262278;
 //BA.debugLineNum = 262278;BA.debugLine="branchSales3= GetMapValueOrDefault(specifi";
_branchsales3 = (int)(BA.ObjectToNumber(_getmapvalueordefault(_specificbranch,"sales3",(Object)(0))));
RDebugUtils.currentLine=262280;
 //BA.debugLineNum = 262280;BA.debugLine="Log($\"Company: ${name}, Branch: ${branchNa";
anywheresoftware.b4a.keywords.Common.LogImpl("2262280",("Company: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_name))+", Branch: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_branchname))+", Sales1: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_branchsales1))+", Sales2: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_branchsales2))+", Sales3: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_branchsales3))+""),0);
 }
};
 }else {
RDebugUtils.currentLine=262283;
 //BA.debugLineNum = 262283;BA.debugLine="Log($\"Company: ${name} has no branches info";
anywheresoftware.b4a.keywords.Common.LogImpl("2262283",("Company: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_name))+" has no branches information."),0);
 };
RDebugUtils.currentLine=262286;
 //BA.debugLineNum = 262286;BA.debugLine="If Activity.Width >= 1340 Then";
if (mostCurrent._activity.getWidth()>=1340) { 
RDebugUtils.currentLine=262287;
 //BA.debugLineNum = 262287;BA.debugLine="count = count + 1";
_count = (int) (_count+1);
RDebugUtils.currentLine=262288;
 //BA.debugLineNum = 262288;BA.debugLine="If count Mod numColumns = 0 Then";
if (_count%_numcolumns==0) { 
RDebugUtils.currentLine=262290;
 //BA.debugLineNum = 262290;BA.debugLine="leftPosition = 10dip";
_leftposition = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
RDebugUtils.currentLine=262291;
 //BA.debugLineNum = 262291;BA.debugLine="topPosition = topPosition + pnlHeight + pa";
_topposition = (int) (_topposition+_pnlheight+_padding);
 }else {
RDebugUtils.currentLine=262294;
 //BA.debugLineNum = 262294;BA.debugLine="leftPosition = leftPosition + pnlWidth + p";
_leftposition = (int) (_leftposition+_pnlwidth+_padding);
 };
RDebugUtils.currentLine=262296;
 //BA.debugLineNum = 262296;BA.debugLine="scrollHeight = scrollHeight + 175dip";
_scrollheight = (int) (_scrollheight+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (175)));
 }else {
RDebugUtils.currentLine=262298;
 //BA.debugLineNum = 262298;BA.debugLine="topPosition = topPosition + pnlHeight + pad";
_topposition = (int) (_topposition+_pnlheight+_padding);
RDebugUtils.currentLine=262299;
 //BA.debugLineNum = 262299;BA.debugLine="scrollHeight = scrollHeight + 300dip + padd";
...
RDebugUtils.currentLine=262303;
 //BA.debugLineNum = 262303;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=262304;
 //BA.debugLineNum = 262304;BA.debugLine="cd.Initialize2(Colors.White, 0dip, 1dip, Col";
...
RDebugUtils.currentLine=262305;
 //BA.debugLineNum = 262305;BA.debugLine="Panel.Background = cd";
_panel.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 }
};
RDebugUtils.currentLine=262308;
 //BA.debugLineNum = 262308;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
_totalcompanies = _salesarray.getSize();
RDebugUtils.currentLine=262309;
 //BA.debugLineNum = 262309;BA.debugLine="Dim sales(totalCompanies) As Int";
_sales = new int[_totalcompanies];
;
RDebugUtils.currentLine=262310;
 //BA.debugLineNum = 262310;BA.debugLine="Dim sales1(totalCompanies) As Int";
_sales1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262311;
 //BA.debugLineNum = 262311;BA.debugLine="Dim sales2(totalCompanies) As Int";
_sales2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262312;
 //BA.debugLineNum = 262312;BA.debugLine="Dim purchase(totalCompanies) As Int";
_purchase = new int[_totalcompanies];
;
RDebugUtils.currentLine=262313;
 //BA.debugLineNum = 262313;BA.debugLine="Dim purchase1(totalCompanies) As Int";
_purchase1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262314;
 //BA.debugLineNum = 262314;BA.debugLine="Dim purchase2(totalCompanies) As Int";
_purchase2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=262315;
 //BA.debugLineNum = 262315;BA.debugLine="Dim companyName(totalCompanies) As String";
_companyname = new String[_totalcompanies];
java.util.Arrays.fill(_companyname,"");
RDebugUtils.currentLine=262320;
 //BA.debugLineNum = 262320;BA.debugLine="For i = 0 To totalCompanies - 1";
{
final int step142 = 1;
...
RDebugUtils.currentLine=262321;
 //BA.debugLineNum = 262321;BA.debugLine="Dim record As Map = salesArray.Get(i)";
_record = new anywheresoftware.b4a.objects.collections.Map();
...
RDebugUtils.currentLine=262322;
 //BA.debugLineNum = 262322;BA.debugLine="companyName(i) = record.GetDefault(\"company_";
_companyname[_i] = BA.ObjectToString(_record.GetDefault((Object)("company_name"),(Object)("Unknown")));
RDebugUtils.currentLine=262323;
 //BA.debugLineNum = 262323;BA.debugLine="sales(i) = record.GetDefault(\"sales_1\", 0)";
_sales[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("sales_1"),(Object)(0))));
RDebugUtils.currentLine=262324;
 //BA.debugLineNum = 262324;BA.debugLine="sales1(i) = record.GetDefault(\"sales_2\", 0)";
_sales1[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("sales_2"),(Object)(0))));
RDebugUtils.currentLine=262325;
 //BA.debugLineNum = 262325;BA.debugLine="sales2(i) = record.GetDefault(\"sales_3\", 0)";
_sales2[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("sales_3"),(Object)(0))));
RDebugUtils.currentLine=262326;
 //BA.debugLineNum = 262326;BA.debugLine="purchase(i) = record.GetDefault(\"purchase_1\"";
_purchase[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_1"),(Object)(0))));
RDebugUtils.currentLine=262327;
 //BA.debugLineNum = 262327;BA.debugLine="purchase1(i) = record.GetDefault(\"purchase_2";
_purchase1[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_2"),(Object)(0))));
RDebugUtils.currentLine=262328;
 //BA.debugLineNum = 262328;BA.debugLine="purchase2(i) = record.GetDefault(\"purchase_\"";
_purchase2[_i] = (int)(BA.ObjectToNumber(_record.GetDefault((Object)("purchase_"),(Object)(0))));
 }
};
RDebugUtils.currentLine=262332;
 //BA.debugLineNum = 262332;BA.debugLine="barPanel.RemoveAllViews";
mostCurrent._barpanel.RemoveAllViews();
RDebugUtils.currentLine=262333;
 //BA.debugLineNum = 262333;BA.debugLine="barPanel.Invalidate ' Force redraw";
mostCurrent._barpanel.Invalidate();
RDebugUtils.currentLine=262335;
 //BA.debugLineNum = 262335;BA.debugLine="Dim legend() As String = Array As String(\"Sal";
mostCurrent._legend = new String[]{"Sales1","Sales2","Sales3"};
RDebugUtils.currentLine=262336;
 //BA.debugLineNum = 262336;BA.debugLine="barGraph.Initialize(Activity, barPanel, sales";
mostCurrent._bargraph._initialize /*String*/ (null,mostCurrent.activityBA,mostCurrent._activity,mostCurrent._barpanel,_sales,_sales1,_sales2,_companyname,mostCurrent._legend,(int) (10000),"Total Sales of the Company");
RDebugUtils.currentLine=262337;
 //BA.debugLineNum = 262337;BA.debugLine="legend = Array As String(\"Purchase1\",\"Purchas";
mostCurrent._legend = new String[]{"Purchase1","Purchase2","Purchase3"};
RDebugUtils.currentLine=262338;
 //BA.debugLineNum = 262338;BA.debugLine="barGraph1.Initialize(Activity, purchasePanel,";
mostCurrent._bargraph1._initialize /*String*/ (null,mostCurrent.activityBA,mostCurrent._activity,mostCurrent._purchasepanel,_purchase,_purchase1,_purchase2,_companyname,mostCurrent._legend,(int) (10000),"Total Purchase of the Company");
 break; }
case 1: {
RDebugUtils.currentLine=262341;
 //BA.debugLineNum = 262341;BA.debugLine="ToastMessageShow(\"Data updated successfully\",";
...
RDebugUtils.currentLine=262342;
 //BA.debugLineNum = 262342;BA.debugLine="LoadCompanyData";
_loadcompanydata();
 break; }
default: {
RDebugUtils.currentLine=262344;
 //BA.debugLineNum = 262344;BA.debugLine="Log(\"Unknown job: \" & job.JobName)";
anywheresoftware.b4a.keywords.Common.LogImpl("2262344","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
       catch (Exception e165) {
			processBA.setLastException(e165);RDebugUtils.currentLine=262347;
 //BA.debugLineNum = 262347;BA.debugLine="ToastMessageShow(\"Error parsing sales data\", Tr";
...
RDebugUtils.currentLine=262350;
 //BA.debugLineNum = 262350;BA.debugLine="ToastMessageShow(\"Error: \" & job.ErrorMessage, T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Error: "+_job._errormessage /*String*/ ),anywheresoftware.b4a.keywords.Common.True);
 };
RDebugUtils.currentLine=262352;
 //BA.debugLineNum = 262352;BA.debugLine="job.Release";
_job._release /*String*/ (null);
RDebugUtils.currentLine=262353;
 //BA.debugLineNum = 262353;BA.debugLine="End Sub";
return "";
}
