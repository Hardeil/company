...
anywheresoftware.b4a.keywords.Common.LogImpl("4196615",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
...
try {RDebugUtils.currentLine=262148;
 //BA.debugLineNum = 262148;BA.debugLine="PHPURLCompany = $\"https://192.168.8.117/Company/";
...
anywheresoftware.b4a.keywords.Common.LogImpl("4262155","LoadGraphData Error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("4786433","Default",0);
...
RDebugUtils.currentLine=327770;
 //BA.debugLineNum = 327770;BA.debugLine="Dim imgView As ImageView";
_imgview = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=327771;
 //BA.debugLineNum = 327771;BA.debugLine="imgView.Initialize(\"\")";
_imgview.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327772;
 //BA.debugLineNum = 327772;BA.debugLine="imgView.Gravity = Gravity.FILL";
_imgview.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
...
anywheresoftware.b4a.keywords.Common.LogImpl("4327776","Error loading image",0);
 };
...
RDebugUtils.currentLine=327825;
 //BA.debugLineNum = 327825;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=327826;
 //BA.debugLineNum = 327826;BA.debugLine="cd.Initialize2(Colors.White, 0dip, 0dip, Col";
...
RDebugUtils.currentLine=327827;
 //BA.debugLineNum = 327827;BA.debugLine="Panel.Background = cd";
_panel.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
RDebugUtils.currentLine=327828;
 //BA.debugLineNum = 327828;BA.debugLine="count = count + 1";
_count = (int) (_count+1);
 }
};
RDebugUtils.currentLine=327831;
 //BA.debugLineNum = 327831;BA.debugLine="totalGetDataHeight = Panel2.Height+companyPan";
_totalgetdataheight = (int) (mostCurrent._panel2.getHeight()+mostCurrent._companypanel.getHeight());
 break; }
case 1: {
RDebugUtils.currentLine=327833;
 //BA.debugLineNum = 327833;BA.debugLine="Dim salesArray As List = parser.NextArray";
_salesarray = new anywheresoftware.b4a.objects.collections.List();
_salesarray = _parser.NextArray();
RDebugUtils.currentLine=327837;
 //BA.debugLineNum = 327837;BA.debugLine="If salesArray.Size = 0 Then";
if (_salesarray.getSize()==0) { 
RDebugUtils.currentLine=327838;
 //BA.debugLineNum = 327838;BA.debugLine="ToastMessageShow(\"No data received\", True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("No data received"),anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=327839;
 //BA.debugLineNum = 327839;BA.debugLine="Return";
if (true) return "";
 };
RDebugUtils.currentLine=327842;
 //BA.debugLineNum = 327842;BA.debugLine="Dim totalCompanies As Int = salesArray.Size";
_totalcompanies = _salesarray.getSize();
RDebugUtils.currentLine=327843;
 //BA.debugLineNum = 327843;BA.debugLine="Dim sales(totalCompanies) As Int";
_sales = new int[_totalcompanies];
;
RDebugUtils.currentLine=327844;
 //BA.debugLineNum = 327844;BA.debugLine="Dim comId(totalCompanies) As Int";
_comid = new int[_totalcompanies];
;
RDebugUtils.currentLine=327845;
 //BA.debugLineNum = 327845;BA.debugLine="Dim sales1(totalCompanies) As Int";
_sales1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=327846;
 //BA.debugLineNum = 327846;BA.debugLine="Dim sales2(totalCompanies) As Int";
_sales2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=327847;
 //BA.debugLineNum = 327847;BA.debugLine="Dim purchase(totalCompanies) As Int";
_purchase = new int[_totalcompanies];
;
RDebugUtils.currentLine=327848;
 //BA.debugLineNum = 327848;BA.debugLine="Dim purchase1(totalCompanies) As Int";
_purchase1 = new int[_totalcompanies];
;
RDebugUtils.currentLine=327849;
 //BA.debugLineNum = 327849;BA.debugLine="Dim purchase2(totalCompanies) As Int";
_purchase2 = new int[_totalcompanies];
;
RDebugUtils.currentLine=327850;
 //BA.debugLineNum = 327850;BA.debugLine="Dim companyName(totalCompanies) As String";
_companyname = new String[_totalcompanies];
java.util.Arrays.fill(_companyname,"");
RDebugUtils.currentLine=327851;
 //BA.debugLineNum = 327851;BA.debugLine="Dim max_value(totalCompanies) As Int";
_max_value = new int[_totalcompanies];
;
RDebugUtils.currentLine=327852;
 //BA.debugLineNum = 327852;BA.debugLine="Dim maxSale As Int=0";
_maxsale = (int) (0);
RDebugUtils.currentLine=327854;
 //BA.debugLineNum = 327854;BA.debugLine="For i = 0 To totalCompanies - 1";
{
final int step142 = 1;
...
RDebugUtils.currentLine=327855;
 //BA.debugLineNum = 327855;BA.debugLine="Dim record As Map = salesArray.Get(i)";
_record = new anywheresoftware.b4a.objects.collections.Map();
...
RDebugUtils.currentLine=327886;
 //BA.debugLineNum = 327886;BA.debugLine="Dim myImage As Bitmap";
_myimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
RDebugUtils.currentLine=327887;
 //BA.debugLineNum = 327887;BA.debugLine="myImage = LoadBitmap(File.DirAssets, \"stock.p";
...
RDebugUtils.currentLine=327889;
 //BA.debugLineNum = 327889;BA.debugLine="Dim imgView As ImageView";
_imgview = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=327890;
 //BA.debugLineNum = 327890;BA.debugLine="imgView.Initialize(\"\")";
_imgview.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327891;
 //BA.debugLineNum = 327891;BA.debugLine="imgView.Gravity = Gravity.FILL";
_imgview.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
RDebugUtils.currentLine=327892;
 //BA.debugLineNum = 327892;BA.debugLine="imgView.Bitmap = myImage";
_imgview.setBitmap((android.graphics.Bitmap)(_myimage.getObject()));
RDebugUtils.currentLine=327893;
 //BA.debugLineNum = 327893;BA.debugLine="imgView.Bitmap = myImage";
_imgview.setBitmap((android.graphics.Bitmap)(_myimage.getObject()));
RDebugUtils.currentLine=327894;
 //BA.debugLineNum = 327894;BA.debugLine="totalSalePanel.AddView(imgView, 0dip, 12.5dip";
...
RDebugUtils.currentLine=327904;
 //BA.debugLineNum = 327904;BA.debugLine="AdjustFontSizeToHeight(totalSaleLabel,2)";
_adjustfontsizetoheight(_totalsalelabel,(float) (2));
RDebugUtils.currentLine=327907;
 //BA.debugLineNum = 327907;BA.debugLine="ScrollView1.Panel.AddView(barPanel,25dip,tota";
...
RDebugUtils.currentLine=327908;
 //BA.debugLineNum = 327908;BA.debugLine="barPanel.Color = Colors.White";
mostCurrent._barpanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=327910;
 //BA.debugLineNum = 327910;BA.debugLine="barPanel.RemoveAllViews";
mostCurrent._barpanel.RemoveAllViews();
RDebugUtils.currentLine=327911;
 //BA.debugLineNum = 327911;BA.debugLine="barPanel.Invalidate ' Force a redraw";
mostCurrent._barpanel.Invalidate();
RDebugUtils.currentLine=327914;
 //BA.debugLineNum = 327914;BA.debugLine="barGraph.Initialize(Activity,barPanel,sales,s";
...
RDebugUtils.currentLine=327915;
 //BA.debugLineNum = 327915;BA.debugLine="legend = Array As String(\"Purchase1\",\"Purchas";
mostCurrent._legend = new String[]{"Purchase1","Purchase2","Purchase3"};
RDebugUtils.currentLine=327917;
 //BA.debugLineNum = 327917;BA.debugLine="Dim totalPurchasePanel As Panel";
_totalpurchasepanel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=327918;
 //BA.debugLineNum = 327918;BA.debugLine="totalPurchasePanel.Initialize(\"\")";
_totalpurchasepanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327919;
 //BA.debugLineNum = 327919;BA.debugLine="ScrollView1.Panel.AddView(totalPurchasePanel,";
...
RDebugUtils.currentLine=327921;
 //BA.debugLineNum = 327921;BA.debugLine="Dim myImage As Bitmap";
_myimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
RDebugUtils.currentLine=327922;
 //BA.debugLineNum = 327922;BA.debugLine="myImage = LoadBitmap(File.DirAssets, \"stock.p";
_myimage = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"stock.png");
RDebugUtils.currentLine=327924;
 //BA.debugLineNum = 327924;BA.debugLine="Dim imgView As ImageView";
_imgview = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=327925;
 //BA.debugLineNum = 327925;BA.debugLine="imgView.Initialize(\"\")";
_imgview.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327926;
 //BA.debugLineNum = 327926;BA.debugLine="imgView.Gravity = Gravity.FILL";
_imgview.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
RDebugUtils.currentLine=327927;
 //BA.debugLineNum = 327927;BA.debugLine="imgView.Bitmap = myImage";
_imgview.setBitmap((android.graphics.Bitmap)(_myimage.getObject()));
RDebugUtils.currentLine=327928;
 //BA.debugLineNum = 327928;BA.debugLine="totalPurchasePanel.AddView(imgView, 0dip, 12.";
...
RDebugUtils.currentLine=327935;
 //BA.debugLineNum = 327935;BA.debugLine="totalPurchaseLabel.Typeface = Typeface.MONOSP";
_totalpurchaselabel.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.MONOSPACE);
RDebugUtils.currentLine=327936;
 //BA.debugLineNum = 327936;BA.debugLine="totalPurchasePanel.AddView(totalPurchaseLabel";
...
RDebugUtils.currentLine=327939;
 //BA.debugLineNum = 327939;BA.debugLine="Dim shadowPurchPanel As Panel";
_shadowpurchpanel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=327940;
 //BA.debugLineNum = 327940;BA.debugLine="shadowPurchPanel.Initialize(\"\")";
_shadowpurchpanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327941;
 //BA.debugLineNum = 327941;BA.debugLine="shadowPurchPanel.Color = Colors.ARGB(50, 138,";
...
RDebugUtils.currentLine=327942;
 //BA.debugLineNum = 327942;BA.debugLine="ScrollView1.Panel.AddView(shadowPurchPanel, 2";
...
RDebugUtils.currentLine=327944;
 //BA.debugLineNum = 327944;BA.debugLine="purchasePanel.Initialize(\"\")";
mostCurrent._purchasepanel.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327945;
 //BA.debugLineNum = 327945;BA.debugLine="purchasePanel.Color = Colors.White";
mostCurrent._purchasepanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=327946;
 //BA.debugLineNum = 327946;BA.debugLine="ScrollView1.Panel.AddView(purchasePanel,25dip";
...
RDebugUtils.currentLine=327947;
 //BA.debugLineNum = 327947;BA.debugLine="purchNxtBtn.Initialize(\"\")";
mostCurrent._purchnxtbtn.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327948;
 //BA.debugLineNum = 327948;BA.debugLine="purchBackBtn.Initialize(\"\")";
mostCurrent._purchbackbtn.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=327949;
 //BA.debugLineNum = 327949;BA.debugLine="sortBtn1.Initialize(\"sortBtn1\")";
mostCurrent._sortbtn1.Initialize(mostCurrent.activityBA,"sortBtn1");
RDebugUtils.currentLine=327950;
 //BA.debugLineNum = 327950;BA.debugLine="sortBtn2.Initialize(\"sortBtn2\")";
mostCurrent._sortbtn2.Initialize(mostCurrent.activityBA,"sortBtn2");
RDebugUtils.currentLine=327951;
 //BA.debugLineNum = 327951;BA.debugLine="defBtn.Initialize(\"defBtn\")";
mostCurrent._defbtn.Initialize(mostCurrent.activityBA,"defBtn");
RDebugUtils.currentLine=327952;
 //BA.debugLineNum = 327952;BA.debugLine="sales1btn.Initialize(\"sales1btn\")";
mostCurrent._sales1btn.Initialize(mostCurrent.activityBA,"sales1btn");
RDebugUtils.currentLine=327953;
 //BA.debugLineNum = 327953;BA.debugLine="sales2btn.Initialize(\"sales2btn\")";
mostCurrent._sales2btn.Initialize(mostCurrent.activityBA,"sales2btn");
RDebugUtils.currentLine=327954;
 //BA.debugLineNum = 327954;BA.debugLine="sales3btn.Initialize(\"sales3btn\")";
mostCurrent._sales3btn.Initialize(mostCurrent.activityBA,"sales3btn");
RDebugUtils.currentLine=327956;
 //BA.debugLineNum = 327956;BA.debugLine="barGraph1.Initialize(Activity, purchasePanel,";
...
RDebugUtils.currentLine=327957;
 //BA.debugLineNum = 327957;BA.debugLine="Log($\"maxSale:${maxSale}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("4327957",("maxSale:"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_maxsale))+""),0);
RDebugUtils.currentLine=327959;
 //BA.debugLineNum = 327959;BA.debugLine="totalGraphDataHeight = totalSaleLabel.Height+";
...
RDebugUtils.currentLine=327973;
 //BA.debugLineNum = 327973;BA.debugLine="LoadCompanyData";
_loadcompanydata();
 break; }
default: {
RDebugUtils.currentLine=327975;
 //BA.debugLineNum = 327975;BA.debugLine="Log(\"Unknown job: \" & job.JobName)";
anywheresoftware.b4a.keywords.Common.LogImpl("4327975","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
 ...
 //BA.debugLineNum = 327980;BA.debugLine="ToastMessageShow(\"Error parsing sales data\", Tr";
...
anywheresoftware.b4a.keywords.Common.LogImpl("4655361","sad",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("4917512",mostCurrent._sortdefaultvalue,0);
RDebugUtils.currentLine=917513;
 //BA.debugLineNum = 917513;BA.debugLine="Log(\" sales 1 Button clicked: \" & index)";
anywheresoftware.b4a.keywords.Common.LogImpl("4917513"," sales 1 Button clicked: "+_index,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("4983047",mostCurrent._sortdefaultvalue,0);
RDebugUtils.currentLine=983048;
 //BA.debugLineNum = 983048;BA.debugLine="Log(\" sales 2 Button clicked: \" & index)";
anywheresoftware.b4a.keywords.Common.LogImpl("4983048"," sales 2 Button clicked: "+_index,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("41048583",mostCurrent._sortdefaultvalue,0);
RDebugUtils.currentLine=1048584;
 //BA.debugLineNum = 1048584;BA.debugLine="Log(\" sales 3 Button clicked: \" & index)";
anywheresoftware.b4a.keywords.Common.LogImpl("41048584"," sales 3 Button clicked: "+_index,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("4851973",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("4720901",("sort value: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(mostCurrent._sortdefaultvalue))+""),0);
RDebugUtils.currentLine=720902;
 //BA.debugLineNum = 720902;BA.debugLine="LoadGraphData";
_loadgraphdata();
RDebugUtils.currentLine=720903;
 //BA.debugLineNum = 720903;BA.debugLine="Log(\"descending\")";
anywheresoftware.b4a.keywords.Common.LogImpl("4720903","descending",0);
